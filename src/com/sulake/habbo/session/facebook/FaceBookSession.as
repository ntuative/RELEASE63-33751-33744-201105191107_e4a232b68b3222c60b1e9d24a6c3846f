package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1004:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1386:String = "sendAccessTokenToServer";
      
      private static const const_1385:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1386,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1385,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1004);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1004);
         }
      }
