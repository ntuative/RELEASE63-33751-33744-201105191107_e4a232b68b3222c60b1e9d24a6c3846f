package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_891:Array = [];
      
      private static var var_1689:int = 200;
      ...
      {
         this.var_725 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1636;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_891.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_725.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_891.length < var_1689)
         {
            ...
            param1.width = this.var_725.width;
            param1.height = this.var_725.height;
            var_891.push(param1);
         }
         else
         {
