package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1145:String = "issue_bundle_open";
      
      public static const const_800:String = "issue_bundle_my";
      
      public static const const_1198:String = "issue_bundle_picked";
      
      public static const const_1655:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_632 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1210 = [];
         this.var_1209 = [];
         this.var_964 = new Map();
         this.var_2499 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1837 = new Timer(const_1655,0);
         this.var_1837.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1837.start();
      }
      ...
      {
         var _loc4_:IssueBundle = this.var_107.getValue(param1) as IssueBundle;
         if(_loc4_ == null)
         {
            return;
         }
         this.sendPick(_loc4_.getIssueIds(),param2,param3);
         this.var_1210 = this.var_1210.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = this.var_107.getValues();
      ...
      public function releaseAll() : void
      {
         ...
         var _loc2_:* = [];
         for each(_loc3_ in this.var_107)
         {
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         var _loc2_:IssueBundle = this.var_107.getValue(param1) as IssueBundle;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1209 = this.var_1209.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_632 == null || !this.var_632.isOpen())
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1293);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_965.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_107.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  {
                     this.var_107.remove(_loc3_.id);
                     this.removeHandler(_loc3_.id);
                  }
                  this.var_965.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1767)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_107)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_965.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            this.var_965.add(param1.issueId,_loc2_);
            this.var_107.add(_loc2_,_loc3_);
         }
         if(_loc3_ == null)
         {
            return;
         }
         if(this.var_1210.indexOf(param1.issueId) != -1)
         {
            this.handleBundle(_loc3_.id);
            _loc5_ = this.var_67.sessionDataManager.userId;
            if(_loc5_ != param1.pickerUserId)
            {
               if(param1.state == IssueMessageData.const_399)
               {
         ...
         {
            _loc6_ = this.getBundles(const_800);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1209.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2499);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_964.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_964.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_965.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_107.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_964.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_964.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      {
         var _loc3_:IssueBundle = this.var_107.getValue(param1) as IssueBundle;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function autoHandle(param1:int) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:Array = this.var_107.getValues();
         var _loc4_:int = this.var_67.sessionDataManager.userId;
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.state == IssueMessageData.const_399 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            _loc8_ = null;
            for each(_loc9_ in this.var_107)
            {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_964.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
