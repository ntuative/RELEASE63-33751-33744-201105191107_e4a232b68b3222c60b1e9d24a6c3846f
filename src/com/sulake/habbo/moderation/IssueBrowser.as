package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2245:String = "my_issues";
      
      private const const_2246:String = "open_issues";
      
      private const const_2244:String = "picked_issues";
      
      private const const_2250:String = "closed_issues";
      ...
      private var var_2026:IIssueBrowserView;
      
      private var var_2027:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_277 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_277.numTabItems)
            {
               _loc5_ = this.var_277.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_49,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_277 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_277 == null || this.var_277.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_277.selector.getSelectableByName("open_issues");
         this.var_277.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_393 == _loc2_)
         {
            return;
         }
         if(this.var_393 != null)
         {
            this.var_393.visible = false;
         }
         this.var_393 = _loc2_;
         if(this.var_393 == null)
         {
         ...
         this.var_393.view.width = this.var_277.container.width;
         this.var_393.view.height = this.var_277.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2245:
               if(this.var_2026 == null)
               {
                  this.var_2026 = new MyIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_2026;
            case this.const_2246:
               if(this.var_2027 == null)
               {
                  this.var_2027 = new OpenIssuesView(this.issueManager,this,this.var_277.container);
               }
               return this.var_2027;
            case this.const_2244:
               if(this.var_2025 == null)
               {
                  this.var_2025 = new PickedIssuesView(this.issueManager,this,this.var_277.container);
               }
