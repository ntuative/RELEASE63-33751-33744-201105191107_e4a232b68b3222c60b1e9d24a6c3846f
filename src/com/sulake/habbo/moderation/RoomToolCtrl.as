package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1164:IDropMenuWindow;
      
      private var var_542:ITextFieldWindow;
      
      private var var_577:Boolean = true;
      
      private var var_1003:ICheckBoxWindow;
      
      private var var_1514:ICheckBoxWindow;
      
      private var var_1513:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_345));
         Logger.log("BEGINNING TO SHOW: " + this.var_345);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1766;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_345);
         if(param1.flatId != this.var_345)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_345);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1164 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1164);
         this.var_1164.procedure = this.onSelectTemplate;
         this.var_1003 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1514 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1513 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_803,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_577 || this.var_542.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1003.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1737,_loc2_,this.var_542.text,"",""));
         if(this.var_1514.isSelected || this.var_1513.isSelected || this.var_1003.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1514.isSelected,this.var_1513.isSelected,this.var_1003.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1623);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1616);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1164.selection];
         if(_loc3_ != null)
         {
            this.var_577 = false;
