package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1011:int = 60;
      
      private static const const_1013:int = 3600;
      
      private static const const_1012:int = 86400;
      
      private static const const_1010:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1011)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1013)
         {
            return Math.round(param1 / const_1011) + " mins ago";
         }
         if(param1 < 2 * const_1012)
         {
            return Math.round(param1 / const_1013) + " hours ago";
         }
         if(param1 < 2 * const_1010)
         {
            return Math.round(param1 / const_1012) + " days ago";
         }
         return Math.round(param1 / const_1010) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1171.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1171.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1237,this._data.userId),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1562),this._callerFrame,this.var_1170,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1562),this._callerFrame,this.var_1170,false,true);
      }
