package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_766:IssueMessageData = null;
      
      private var var_767:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2401 = param2.pickerUserId;
         this.var_2400 = param2.pickerUserName;
         this.var_1497 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1179 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1180;
         }
         if(this.var_766 == null || param1.timeStamp < this.var_766.timeStamp)
         {
            this.var_766 = param1;
         }
         if(this.var_767 == null || param1.priority > this.var_767.timeStamp)
         {
            this.var_767 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_767;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_766;
         if(_loc2_ == null)
         {
