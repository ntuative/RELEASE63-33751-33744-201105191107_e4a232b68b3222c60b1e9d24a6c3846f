package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_511:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_170.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_164,HabboWindowStyle.const_46,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1963,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1963,"/");
         ...
         {
            dispatchEvent(new Event(const_511));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_145.removeEventListener(SSOTicket.const_393,this.onParsedTicketSuccess);
            this.var_145.removeEventListener(SSOTicket.const_339,this.onParsedTicketFailure);
            this.var_145 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_145 = new SSOTicket(this.var_170.assets,_loc3_,_loc2_,param1);
         this.var_145.addEventListener(SSOTicket.const_393,this.onParsedTicketSuccess);
         this.var_145.addEventListener(SSOTicket.const_339,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_145.ticket);
         Logger.log("Has Facebook: " + this.var_145.isFacebookUser);
         if(this.var_145.isFacebookUser)
         {
            this.var_170.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_170.flashClientUrl = this.var_145.flashClientUrl;
         this.var_170.ssoTicket = this.var_145.ticket;
         this.var_145.removeEventListener(SSOTicket.const_393,this.onParsedTicketSuccess);
         this.var_145.removeEventListener(SSOTicket.const_339,this.onParsedTicketFailure);
         this.var_145 = null;
         dispatchEvent(new Event(const_511));
