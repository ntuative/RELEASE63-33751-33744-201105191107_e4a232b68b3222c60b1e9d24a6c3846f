package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1714:uint = 1;
      
      public static const const_1726:uint = 2;
       
      
      private var var_1577:IProtocolEncoder;
      ...
      {
         super();
         this.var_1577 = new WedgieEncoder();
         this.var_1156 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1577.dispose();
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1714)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1156.getID(_loc4_);
