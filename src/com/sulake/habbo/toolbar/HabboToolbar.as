package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1018:ToolbarExtension;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_247.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_247 && this._windowManager && this._config)
         {
            this.var_247.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1018 = new ToolbarExtension(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
      ...
      public function setToolbarState(param1:String) : void
      {
         switch(param1)
         {
            case HabboToolbarEnum.const_886:
               this.var_1018.hideRoomInfo();
               break;
            case HabboToolbarEnum.const_891:
               this.var_1018.showRoomInfo();
         }
         if(this._view)
         {
