package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1533:Point = new Point(3,3);
      
      private static const const_1565:uint = 7433577;
      
      private static const const_1566:uint = 5723213;
      
      private static const const_460:String = "_hover";
      
      private static const const_459:String = "_normal";
      
      private static const const_994:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1533;
         ...
         {
            this.setIconHoverState(_loc11_,const_459);
         }
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_886:
               _loc3_ = false;
               break;
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_459);
               this.setIconBgHoverState(_loc3_,const_459);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_460 ? this.var_1599 : this.var_1600;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_460)
         {
            param1.color = const_1565;
         }
         else
         {
            param1.color = const_1566;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1600)
         {
            this.var_1600.dispose();
         }
         this.var_1600 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1599)
         {
            this.var_1599.dispose();
         }
         this.var_1599 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1067.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_994;
            _loc2_.y = const_994;
            this.var_1067.add(param1,_loc2_);
         }
         return _loc2_;
      }
