package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1545:uint = 16777215;
      
      private static const const_1546:uint = 12247545;
      
      private static const const_1544:String = "HELP";
      
      private static const const_1547:String = "ROOMINFO";
      ...
      private var var_352:IWindow;
      
      private var var_682:IWindowContainer;
      
      private const const_832:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_352 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_58.removeListItem(this.var_352);
      }
      
      public function showRoomInfo() : void
      {
         this.var_58.addListItemAt(this.var_352,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_728;
         _loc3_.y = this.const_832;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_682)
         {
            this.var_682 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1547);
               break;
            case "confirm":
               if(false)
               {
