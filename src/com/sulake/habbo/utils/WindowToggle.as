package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      {
         return this.visible && this._window.getStateFlag(WindowState.const_86);
      }
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1031)
            {
               this.var_1031.addChild(this._window);
            }
