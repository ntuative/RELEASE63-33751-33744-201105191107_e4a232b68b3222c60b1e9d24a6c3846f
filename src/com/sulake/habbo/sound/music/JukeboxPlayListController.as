package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_712 = [];
         this.var_712.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_712.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_712.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         if(param1 < 0 || param1 >= this.var_488.length)
         {
            return null;
         }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_609 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            ...
            this.var_424 = _loc3_.currentSongId;
         }
         else
         {
            this.stopPlaying();
         ...
         this.var_1641 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_100,HabboMusicPrioritiesEnum.const_134,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_167));
      }
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  this.var_488[_loc2_] = _loc6_;
               }
               break;
            }
            _loc2_++;
         }
         var _loc3_:int = this.var_711.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_711.splice(_loc3_,1);
         }
         if(this.var_711.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_102));
