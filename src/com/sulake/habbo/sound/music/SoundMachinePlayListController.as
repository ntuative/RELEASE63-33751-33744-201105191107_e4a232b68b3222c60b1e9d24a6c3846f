package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_223 = param2;
         this.var_712 = [];
         this.var_712.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_712.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_712)
         {
         ...
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_717,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomEngineSoundMachineEvent.const_972,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_717,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomEngineSoundMachineEvent.const_972,this.onSoundMachineStopEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_424);
