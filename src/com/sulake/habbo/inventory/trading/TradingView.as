package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1020:uint = 4284532064;
      
      private static const const_1021:uint = 2577770;
      ...
      private var var_623:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_623 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1802 = this.createMinimizedWindow();
         }
         if(!this.var_2436)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1020) : uint(const_1021);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1020) : uint(const_1021);
            }
         ...
         if(this.var_70)
         {
            ...
            switch(this.var_20.state)
            {
               ...
               case TradingModel.const_402:
                  ...
                  break;
               case TradingModel.const_336:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_463:
                  _loc1_.disable();
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1880)
            {
            ...
            this.var_623.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_535);
            this.var_623.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_623.hideDelayed();
         }
      }
         ...
         if(this.var_184.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_623.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_535);
               }
            }
            else
            {
