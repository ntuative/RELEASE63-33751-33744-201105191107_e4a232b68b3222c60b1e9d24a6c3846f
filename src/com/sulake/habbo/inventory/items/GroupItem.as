package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1495:int = 13421772;
      
      private static const const_1496:int = 10275685;
      ...
      private var var_2646:IWindow;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_1052:Boolean;
      ...
      protected var var_1594:Number;
      
      protected var var_876:int = 0;
      
      protected var var_702:BitmapData;
      
      protected var var_2738:int;
      
      protected var var_1625:Boolean;
      
      protected var var_2161:Boolean;
      
      protected var var_2933:BitmapData;
      
      private var var_1598:Boolean;
      
      private const const_1973:Number = 1;
      
      private const const_1974:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2646 = this._window.findChildByName("outline");
         ...
         this.var_2140 = param8;
         this.var_1594 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2160 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1594));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2140);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1974;
               _loc1_.blend = this.const_1974;
            }
            else
            {
               this._window.blend = this.const_1973;
               _loc1_.blend = this.const_1973;
            }
         }
         this.var_1366.color = !!this.var_1598 ? uint(const_1496) : uint(const_1495);
         this.var_2646.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2161 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2933;
               _loc5_.visible = true;
            }
            else
            {
