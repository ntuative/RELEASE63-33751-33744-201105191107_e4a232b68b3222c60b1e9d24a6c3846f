package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1075:int = 2;
      ...
      private var var_219:PetsGridItem;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_219);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_495.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_201.removeGridItem(_loc2_.window);
         if(this.var_219 == _loc2_)
         {
            this.var_219 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_495 == null || this.var_495.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_495.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_495.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_69.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_201.addGridItem(_loc2_.window);
            this.var_495.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_219.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_49)
         {
            ...
            {
               case "tab_floor":
                  this.var_69.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_69.switchToFurnitureCategory(FurniModelCategory.const_44);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_219 != null)
         {
            this.var_219.setSelected(false);
         }
         this.var_219 = param1;
         if(this.var_219 != null)
         {
            this.var_219.setSelected(true);
         }
      ...
      public function updateState() : void
      {
         ...
         if(!this.var_69.isListInitialized())
         {
            _loc2_ = this.const_1073;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_69.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_391) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_69.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_372) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_69.getUnseenItemCount() > 0;
      }
   }
}
