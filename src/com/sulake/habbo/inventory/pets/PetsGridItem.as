package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1526.setSelectedGridItem(this);
               this.var_1525 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1525 = false;
                  this.var_1526.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1366)
         {
            return;
         }
         this.var_1366.color = !!this.var_2647 ? uint(const_1496) : uint(const_1495);
         this.var_2646.visible = param1;
      }
