package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1489:int = 100;
      
      private static const const_1488:int = 1000;
      ...
      private var var_650:Timer;
      
      private var include:Boolean;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1911:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_444 = [];
         this.var_445 = [];
         this.var_650 = new Timer(const_1489,1);
         this.var_650.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_650.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_650.stop();
               this.var_650 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1911 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1911;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_346)
         {
         ...
         if(this.var_816 == null)
         {
            this.var_816 = this._windowManager.buildFromXML(this.var_2621) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_816.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_816.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_74 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_44:
                  ...
                  break;
               case const_250:
                  this._controller.toggleInventoryPage(InventoryCategory.const_129);
            }
         }
      }
      ...
      {
         this.var_2620 = getTimer();
         this.switchCategory(const_250);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_386);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_649.add(const_39,new Array());
         this.var_649.add(const_44,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc6_ = const_44;
            _loc5_ = this.var_445.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_250)
            {
      ...
      {
         return getTimer() < this.var_2620 + const_1488;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_342;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_320 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_346)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_649.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_796)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_445.indexOf(_loc2_) == -1)
            {
               this.var_445.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_391:
               return this.var_444.length;
            case UnseenItemCategoryEnum.const_372:
               return this.var_445.length;
            default:
               return this.var_444.length + this.var_445.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_44:
               if(this.var_445 && this.var_445.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_372));
                  this.var_445 = [];
            ...
            case const_39:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_391));
                  this.var_444 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
