   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_69.toggleItemSelection(this._category,this.var_201.getGridItemIndex(param1.window));
            this.var_519 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_519 != null && this.var_519 == param2 && !this.var_69.isTradingOpen)
         {
