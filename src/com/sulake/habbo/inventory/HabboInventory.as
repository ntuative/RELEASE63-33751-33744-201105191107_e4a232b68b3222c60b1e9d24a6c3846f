package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2226:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_583,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_53.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_342));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_53.getValue(InventoryCategory.const_791));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_360));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_53.getValue(InventorySubCategory.const_1100));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_53.getValue(InventoryCategory.const_129));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_53.getValue(InventoryCategory.const_386) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_583,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1159 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_583:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_397 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_53.add(InventoryCategory.const_386,_loc1_);
         ...
         this.var_53.add(InventoryCategory.const_791,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_397);
         ...
         this.var_53.add(InventorySubCategory.const_342,_loc6_);
         ...
         this.var_53.add(InventorySubCategory.const_1100,_loc7_);
         ...
         this.var_53.add(InventoryCategory.const_129,_loc8_);
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_342:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_987.indexOf(param1) == -1)
            {
               this.var_987.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_987.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_987.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_987.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2226);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_906));
      }
      ...
      {
         var _loc1_:int = this.furniModel.getUnseenItemCount() + this.petsModel.getUnseenItemCount();
         if(_loc1_ != this.var_2552)
         {
            this.var_2552 = _loc1_;
