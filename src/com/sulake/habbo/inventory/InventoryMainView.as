package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1933:Point = new Point(120,150);
      ...
      {
         return !!this.var_17 ? Boolean(this.var_17.getStateFlag(WindowState.const_86)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_726);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_346 != null && this.var_346 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_346 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_726);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_74:
               ...
               break;
            case InventoryCategory.const_129:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_346);
         }
         ...
         _loc2_.container.removeChild(this.var_1691);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_346 == InventoryCategory.const_129)
            {
               this.toggleCategoryView(InventoryCategory.const_129);
            }
            else if(this.var_346 == InventoryCategory.const_74)
            {
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(!this.var_892)
         {
            ...
            _loc4_ = this.var_17.findChildByName("furni") as IWindowContainer;
            if(_loc4_)
            {
               _loc4_.addChild(_loc3_);
               _loc3_.x = _loc4_.width - _loc3_.width - const_994;
               _loc3_.y = const_994;
            }
            this.var_892 = _loc3_;
         }
         if(_loc1_ > 0)
         {
            ...
            this.var_892.findChildByName("count").caption = _loc1_.toString();
         }
         else
         {
