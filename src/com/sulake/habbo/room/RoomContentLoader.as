package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_947:String = "RCL_LOADER_READY";
      
      private static const const_368:String = "RCL_PUBLICROOM_";
      
      private static const const_1972:int = 0;
      
      private static const const_1073:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_456:String = "place_holder";
      
      private static const const_663:String = "wall_place_holder";
      
      private static const const_662:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_456;
      
      private static const const_661:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1079:String = "selection_arrow";
      ...
      private var var_1583:IEventDispatcher = null;
      ...
      private var var_1049:Map = null;
      
      private var _pets:Dictionary;
      
      private var var_1048:Map = null;
      
      private var var_210:PublicRoomData = null;
      
      private var var_1584:Map = null;
      
      private var var_680:Map = null;
      
      private var var_552:Map = null;
      
      private var var_553:Map = null;
      
      private var var_840:Map = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2780 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2779 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1073)
         {
            return;
         }
         this.var_1583 = param1;
         this.var_2781 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2778 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_1049.add(_loc2_,_loc3_);
            _loc2_++;
         }
         this.var_1048 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_551.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_551.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_463.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_463.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_840.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_464.add(_loc3_,_loc4_);
               if(this.var_395[_loc7_] == null)
               {
                  this.var_395[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_681.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_680.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_680.remove(_loc7_);
               this.var_680.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2782)
         {
            ...
            {
               this.var_1583.dispatchEvent(new Event(const_947));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_552 != null)
         {
            this.var_552.remove(param1);
            this.var_552.add(param1,param2);
         }
         if(this.var_553 != null)
         {
            this.var_553.remove(param2);
            this.var_553.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_552 != null)
         {
            _loc2_ = this.var_552.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_329;
         }
         return RoomObjectCategoryEnum.const_182;
      }
      ...
      {
         return [const_456,const_663,const_662,const_661,TILE_CURSOR,const_1079];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_464.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_681.getValue(param1) as String;
      ...
      {
         return this.var_1049.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_1048[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_681.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_840.getValue(param1) != null)
         {
            return this.var_840.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_210 != null && this.var_210.hasWorldType(const_368 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_263 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_680.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_395[_loc4_] == null)
                     {
                        this.var_395[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_428,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1584.getValue(param1) != null)
         {
            this.var_210 = this.var_1584.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2780.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1745);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2779.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_428,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_510,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_1048.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1584.add(param1,_loc4_);
         this.var_210 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_551.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_551.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_551.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_463.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_463.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_463[_loc2_] != null)
         {
            _loc3_ = this.var_463.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_368 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_368 + param1) == RoomObjectCategoryEnum.const_81)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_210.getWorldHeightScale(const_368 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_210 != null)
         {
            return this.var_210.getWorldScale(const_368 + param1);
         }
         return 32;
      }
