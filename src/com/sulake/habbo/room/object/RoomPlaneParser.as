package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_1076:Number = 0.25;
      
      private static const const_1215:Number = 0.25;
      ...
      private var var_1552:Number = 0.0;
      
      private var var_1365:Number = 1.0;
      
      private var _floorThicknessMultiplier:Number = 1.0;
      
      private var var_1043:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_127.push(_loc4_);
            this.var_668.push(_loc5_);
            _loc3_++;
         }
         this.var_248 = param1;
         this._height = param2;
         this.var_453 = this.var_248;
         this.var_454 = -1;
         this.var_455 = this._height;
         this.var_456 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_248 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_127[param2] as Array;
            ...
            if(param3 >= 0)
            {
               ...
               if(param1 > this.var_454)
               {
                  this.var_454 = param1;
               }
               if(param2 < this.var_455)
               {
                  this.var_455 = param2;
               }
            ...
            {
               if(param1 == this.var_453 || param1 == this.var_454)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_455;
                  while(_loc6_ < this.var_456)
                  {
               ...
               if(param2 == this.var_455 || param2 == this.var_456)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_453;
                  while(_loc8_ < this.var_454)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_127[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < this.var_248)
            {
               this.var_668[_loc2_][_loc8_] = this.var_127[_loc2_][_loc8_];
               _loc8_++;
            }
            _loc2_++;
         }
         var _loc3_:Point = findEntranceTile(this.var_127);
         var _loc4_:int = 0;
         if(_loc3_ != null)
         {
         ...
         this.var_1043 = getFloorHeight(this.var_127);
         if(!param1)
         {
         ...
         var _loc6_:* = [];
         var _loc7_:int = 0;
         while(_loc7_ < this.var_127.length)
         {
            _loc5_ = this.var_127[_loc7_];
            _loc9_ = [];
            _loc10_ = 0;
      ...
      {
         var _loc12_:* = null;
         this.addPlane(RoomPlaneData.const_284,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_374,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1215 * this.var_1365;
         var _loc9_:Number = const_1076 * this._floorThicknessMultiplier;
         ...
         this.addPlane(RoomPlaneData.const_284,Vector3d.sum(param1,param3),param2,_loc11_,[_loc10_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_284,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_284,Vector3d.sum(param1,Vector3d.product(param3,-_loc9_ / param3.length)),Vector3d.product(param3,(param3.length + _loc9_) / param3.length),_loc11_,[_loc10_,param4]);
            if(param7)
            {
               _loc12_ = Vector3d.product(param2,_loc8_ / param2.length);
               this.addPlane(RoomPlaneData.const_284,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc12_,-1)),_loc12_,_loc11_,[_loc10_,param2,param4]);
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_127 == null || param1 == this.var_127)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_127.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_127[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_271,param1,param2,param3);
         var _loc13_:IVector3d = param1;
         var _loc14_:* = null;
         var _loc15_:* = null;
         if(_loc12_)
         {
            _loc16_ = const_1076 * this._floorThicknessMultiplier;
            if(param8 > 0)
            {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_271,_loc13_,new Vector3d(0,0,-_loc16_),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_271,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_271,_loc13_,new Vector3d(0,0,-_loc16_),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_271,_loc13_,new Vector3d(0,0,-_loc16_),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getXML() : XML
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_248}" height="{this._height}" wallHeight="{this.var_1552}"/>;
         var _loc2_:int = 0;
         while(_loc2_ < this._height)
         {
            _loc4_ = <tileRow/>;
            _loc5_ = this.var_668[_loc2_];
            _loc6_ = 0;
            while(_loc6_ < this.var_248)
            {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1141;
         }
         var _loc2_:RoomPlaneData = this.var_133[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
