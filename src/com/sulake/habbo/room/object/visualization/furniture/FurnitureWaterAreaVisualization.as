package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1345:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1103)
            {
      ...
      {
         if(this.var_2210 == param1 && this.var_2209 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1345)
            {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1103.indexOf(_loc2_) < 0)
            {
               this.var_1103.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_584[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_584[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_489 == 0 || this.var_583 == 0)
         {
            ...
            this.var_489 = _loc2_.getNumber(RoomObjectVariableEnum.const_357);
            this.var_583 = _loc2_.getNumber(RoomObjectVariableEnum.const_403);
         }
         this.var_410 = [];
         this.var_584 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_489 * 2 + this.var_583 * 2)
         {
            this.var_410.push(false);
            this.var_584.push(ShoreMaskCreatorUtility.const_78);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_410,this.var_584,assetCollection);
      }
