package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_449:int = 2;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1300[param2];
         var _loc4_:int = this.var_1302[param2];
         var _loc5_:int = this.var_1301[param2];
         var _loc6_:Number = this.var_1299[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1083;
         }
         ...
         this.var_1300[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1299[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1300.push(Math.random() * _loc2_ * 1.5);
         this.var_1300.push(Math.random() * _loc2_ * 1.5);
         this.var_1302 = new Array();
         this.var_1302.push(1);
         this.var_1302.push(-1);
         this.var_1301 = new Array();
         this.var_1301.push(const_1550);
         this.var_1301.push(const_1549);
         this.var_1299 = new Array();
         this.var_1299.push(this.getRandomAmplitudeFactor());
         this.var_1299.push(this.getRandomAmplitudeFactor());
      }
