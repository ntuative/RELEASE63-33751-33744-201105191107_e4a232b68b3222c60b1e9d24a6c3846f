package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1926:Number = Math.sqrt(0.5);
      ...
      private var var_2589:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1507 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1507;
            this.var_1507 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_636 != spriteCount)
         {
            createSprites(this.var_636);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2286;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_483 != _loc3_.getUpdateID() || param1 != var_93 || param2 != this.var_2594)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2592 = _loc3_.getNumber(RoomObjectVariableEnum.const_286);
            ...
            this.var_1242 = this.getAdClickUrl(_loc3_);
            if(this.var_1242 == null || this.var_1242.indexOf("http") != 0)
            {
               this.var_1242 = null;
            }
            this.var_2286 = this.var_1242 != null;
            this.var_2589 = _loc3_.getNumber(RoomObjectVariableEnum.const_786);
      ...
      {
         if(this.var_2590 != param2 || this.var_2593 != param1)
         {
            this.var_998 = [];
            this.var_997 = [];
            this.var_804 = [];
            ...
            this.var_2591 = this.getSize(param1);
      ...
      {
         this.var_636 = param1;
         this.var_1508 = this.var_636 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_609.length)
         {
            return "";
         }
         var _loc3_:String = this.var_998[param2];
         var _loc4_:Boolean = this.var_997[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2591;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1508)
            {
               _loc6_ = FurnitureVisualizationData.const_609[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_998[param2] = _loc3_;
            this.var_997[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_803[param3] != null && !this.var_1899)
         {
      ...
      {
         if(this.var_801[param2] != null)
         {
            return this.var_801[param2];
         }
         if(this._data == null)
         {
         ...
         this.var_801[param2] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(this.var_807[param3] != null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_802[param3] != null)
            {
               return this.var_802[param3];
            }
            if(this._data != null)
            {
               _loc4_ = this._data.getYOffset(param1,param2,param3);
               this.var_802[param3] = _loc4_;
               return _loc4_;
            }
            return LayerData.const_561;
         }
         return Math.ceil(this.var_2589 * (param1 / 2));
      }
