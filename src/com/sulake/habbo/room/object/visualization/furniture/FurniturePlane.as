   ...
   public class FurniturePlane
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_203 != null)
         {
            ...
            {
               _loc2_ = this.var_203.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2617)
         {
            if(!param1)
            {
               this.var_313.assign(this.var_814);
               this.var_312.assign(this.var_815);
            }
            else
            {
               this.var_313.assign(this.var_814);
               this.var_313.mul(this.var_815.length / this.var_814.length);
               this.var_312.assign(this.var_815);
               this.var_312.mul(this.var_814.length / this.var_815.length);
            }
            this.var_1629 = -1;
            this.var_1515 = this.var_1515 - 1;
      ...
      {
         var _loc3_:BitmapData = this.var_203.remove(param1) as BitmapData;
      ...
      private function needsNewTexture(param1:IRoomGeometry) : Boolean
      {
         ...
         var _loc3_:BitmapData = this.var_203.getValue(_loc2_) as BitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1))
         {
            ...
            _loc4_ = this.var_203.getValue(_loc3_) as BitmapData;
            if(_loc4_ == null)
            {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_95 == null && this.var_1227 != null || this.var_313 == null || this.var_312 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1629)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1515 || _loc4_.y != this.var_2167 || _loc4_.z != this.var_2165 || param1.scale != this.var_1628))
            {
               this.var_1515 = _loc4_.x;
               this.var_2167 = _loc4_.y;
               this.var_2165 = _loc4_.z;
               ...
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_166.z - _loc7_,this.var_123.z - _loc7_,this.var_89.z - _loc7_,this.var_124.z - _loc7_);
