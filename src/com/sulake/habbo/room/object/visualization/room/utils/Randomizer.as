package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2180:int = 16777216;
      ...
      private var var_1975:int = 16777216;
      
      private var var_2958:int = 69069;
      
      private var var_2957:int = 5;
      ...
      {
         var _loc1_:int = this.var_2958 * this.var_1974 + this.var_2957;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1975;
         this.var_1974 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1975 * param2);
      }
   }
}
