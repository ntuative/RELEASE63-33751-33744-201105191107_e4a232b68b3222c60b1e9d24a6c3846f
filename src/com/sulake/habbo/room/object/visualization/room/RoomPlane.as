package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private static const const_650:Point = new Point(0,0);
      ...
      private var var_983:IPlaneRasterizer = null;
      
      private var var_757:PlaneMaskManager = null;
      ...
      private var var_435:PlaneBitmapData = null;
      ...
      private var var_226:BitmapData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_203 != null)
         {
            ...
            {
               _loc2_ = this.var_203.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_650);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_203.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
         ...
         this.var_435 = param2;
         this.var_203.add(param1,param2);
         return true;
      }
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_203 != null)
         {
            ...
            {
               _loc3_ = this.var_203.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_983.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_435;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_203.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_788 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_376))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_983 != null)
            {
               _loc3_ = this.var_983.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1857,this.var_2544,this.var_2541,this.var_2542,this.var_2543,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1629 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1442.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1442[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1227);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_166.z - originZ,this.var_123.z - originZ,this.var_89.z - originZ,this.var_124.z - originZ);
            ...
            this.var_1629 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2539);
      ...
      {
         this.var_166.assign(param1.getScreenPosition(this.var_95));
         this.var_123.assign(param1.getScreenPosition(Vector3d.sum(this.var_95,this.var_312)));
         this.var_89.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_95,this.var_313),this.var_312)));
         this.var_124.assign(param1.getScreenPosition(Vector3d.sum(this.var_95,this.var_313)));
         ...
         var _loc2_:Number = Math.min(this.var_166.x,this.var_123.x,this.var_89.x,this.var_124.x);
         var _loc3_:Number = Math.max(this.var_166.x,this.var_123.x,this.var_89.x,this.var_124.x);
         var _loc4_:Number = Math.min(this.var_166.y,this.var_123.y,this.var_89.y,this.var_124.y);
         var _loc5_:Number = Math.max(this.var_166.y,this.var_123.y,this.var_89.y,this.var_124.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_166 == null || this.var_123 == null || this.var_89 == null || this.var_124 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_124.x - this.var_89.x;
         var _loc4_:Number = this.var_124.y - this.var_89.y;
         var _loc5_:Number = this.var_123.x - this.var_89.x;
         var _loc6_:Number = this.var_123.y - this.var_89.y;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_981)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_264.length)
            {
               _loc4_ = this.var_264[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_264.length == this.var_982.length)
         {
            while(_loc1_ < this.var_264.length)
            {
               _loc4_ = this.var_264[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_375.length > this.var_1487.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_981 || this.var_264.length == 0 && this.var_375.length == 0 && !this.var_376 || this.var_757 == null)
         {
            return;
         }
         ...
         if(this.var_376)
         {
            ...
            while(_loc5_ < this.var_264.length)
            {
               _loc3_ = this.var_264[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_313.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_312.length;
                  _loc12_ = _loc3_.type;
                  this.var_757.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_375.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_313.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_312.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_313.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_312.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1487.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_376 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_226 != null && (this.var_226.width != param1.width || this.var_226.height != param1.height))
         {
            this.var_226.dispose();
            this.var_226 = null;
         }
         if(this.var_226 == null)
         {
            this.var_226 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_226.copyChannel(param1,param1.rect,const_650,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_226.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_226,this.var_226.rect,const_650,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
