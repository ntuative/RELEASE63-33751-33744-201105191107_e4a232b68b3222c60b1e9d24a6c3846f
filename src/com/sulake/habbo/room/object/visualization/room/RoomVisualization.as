package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1617:int = 16777215;
      
      public static const const_1759:int = 13421772;
      
      private static const const_989:int = 16777215;
      
      private static const const_990:int = 13421772;
      
      private static const const_991:int = 10066329;
      
      private static const const_992:int = 10066329;
      
      public static const const_1723:int = 16777215;
      
      public static const const_1845:int = 13421772;
      
      public static const const_1635:int = 10066329;
      ...
      private var var_707:Rectangle = null;
      
      private var var_486:RoomPlaneBitmapMaskParser = null;
      
      private var var_1385:String = null;
      ...
      private var var_1365:Number = NaN;
      
      private var var_1627:String = null;
      
      private var var_1094:uint = 16777215;
      
      private var var_2169:int = 255;
      
      private var var_2168:int = 255;
      
      private var var_2166:int = 255;
      
      private var var_1630:Boolean = true;
      
      private var var_1095:int = 0;
      
      private var var_1949:int = -1000;
      ...
      private var var_1628:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_486 = new RoomPlaneBitmapMaskParser();
         this.var_290["null"] = false;
         this.var_290["null"] = true;
         this.var_290["null"] = true;
         this.var_290["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_707 = super.boundingRectangle;
         }
         return new Rectangle(this.var_707.x,this.var_707.y,this.var_707.width,this.var_707.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1365))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1365;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1223);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1288);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_374)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1815)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_73,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_374)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1949 + this.const_2200 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_340.length)
            {
               _loc11_ = this.var_576[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_340[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1630)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2166 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2168 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2169 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1629)
         {
            this.var_1629 = param1.updateId;
            this.var_707 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1515 || _loc3_.y != this.var_2167 || _loc3_.z != this.var_2165 || param1.scale != this.var_1628))
            {
               this.var_1515 = _loc3_.x;
               this.var_2167 = _loc3_.y;
               this.var_2165 = _loc3_.z;
               this.var_1628 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1325);
            if(_loc3_ != this.var_1627)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1627 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_759));
            if(_loc4_ != this.var_1094)
            {
               this.var_1094 = _loc4_;
               this.var_2166 = this.var_1094 & 255;
               this.var_2168 = this.var_1094 >> 8 & 255;
               this.var_2169 = this.var_1094 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1202));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_153 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_222);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_191);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_199);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_979));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_792));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_846));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_153 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1213);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1365))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1365 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      {
         if(param1 != this.var_290["null"] || param2 != this.var_290["null"] || param3 != this.var_290["null"])
         {
            this.var_290["null"] = param1;
            this.var_290["null"] = param2;
            this.var_290["null"] = param3;
            this.var_340 = [];
            this.var_576 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_290[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1095;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_486.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_486.maskCount)
         {
            _loc10_ = this.var_486.getMaskType(_loc8_);
            _loc11_ = this.var_486.getMaskLocation(_loc8_);
            _loc12_ = this.var_486.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_73 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_290)
                              {
