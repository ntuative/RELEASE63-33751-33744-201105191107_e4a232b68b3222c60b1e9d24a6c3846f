package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_268:int = 5;
      
      public static const const_882:int = 6;
      
      public static const const_1651:int = const_432;
      ...
      public static const ALIGN_DEFAULT:int = const_116;
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_600,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_116)
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_600);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_600,this.var_31.width,this.var_600);
         }
