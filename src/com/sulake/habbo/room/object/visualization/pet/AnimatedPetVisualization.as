package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1512:String = "head";
      
      private static const const_659:int = 1;
      
      private static const const_1068:int = 1000;
      
      private static const const_1509:String = "pet_experience_bubble_png";
      
      private static const const_1511:int = 0;
      
      private static const const_1510:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1509) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_389 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2705)
            {
               this.var_2705 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_153)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_256);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_140);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_256);
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_93);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_93,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_140);
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_93);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_93,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_1917 = _loc3_.getNumber(RoomObjectVariableEnum.const_390) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_224);
            if(!isNaN(_loc8_))
            {
               this.var_1961 = _loc8_;
            }
            else
            {
               this.var_1961 = direction;
            }
            this.var_1502 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2381 = _loc3_.getNumber(RoomObjectVariableEnum.const_815);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_903);
            if(_loc9_ != this.var_1962)
            {
               this.var_1962 = _loc9_;
               this.var_2706 = this.var_1962.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_389 != null)
         {
            ...
            if(this.var_1502 > 0)
            {
               _loc2_ = param1 - this.var_1502;
               if(_loc2_ < const_1068)
               {
                  this.var_389.alpha = int(Math.sin(_loc2_ / const_1068 * 0) * 255);
                  this.var_389.setExperience(this.var_2381);
               }
               else
               {
                  this.var_1502 = 0;
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_389.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_389.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_271)
         {
            this.var_271 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_93,param1);
            this.setAnimationForIndex(const_1511,_loc3_);
         }
         if(param2 != this.var_1503)
         {
            this.var_1503 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_93,param2);
            this.setAnimationForIndex(const_1510,_loc3_);
         }
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2706);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_659)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_609.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_609[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1961);
         }
         return direction;
      }
      ...
      {
         if(this.var_1025[param1] == null)
         {
            if(this._animationData.getTag(var_93,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1512)
            {
               this.var_1025[param1] = true;
            }
            else
            {
               this.var_1025[param1] = false;
            }
         }
         return this.var_1025[param1];
      }
   }
}
