package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_651:PetVisualizationData = null;
      ...
      private const const_2229:int = 3;
      ...
      private const const_1459:int = 3;
      ...
      private var var_1885:Number = NaN;
      ...
      {
         this.var_651 = param1 as PetVisualizationData;
         createSprites(this.const_1459);
         var _loc2_:BitmapData = (this.var_651.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1917 = param1.getNumber(RoomObjectVariableEnum.const_390) > 0;
            this.var_1503 = param1.getString(RoomObjectVariableEnum.const_140);
            this.var_271 = param1.getString(RoomObjectVariableEnum.const_256);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_939);
            this.var_1885 = param1.getNumber(RoomObjectVariableEnum.const_224);
            this.var_1502 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2381 = param1.getNumber(RoomObjectVariableEnum.const_815);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_214);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_483 != param1.getUpdateID() || this.var_1629 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1885;
            if(isNaN(this.var_1885))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc5_ != this.var_1913 || param3)
            {
               this.var_1913 = _loc5_;
               _loc5_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_651.getAvatar(this.var_618,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_653 = null;
         _loc2_ = getSprite(this.const_1944);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_93 || this.var_60 == null)
         {
            if(_loc7_ != var_93)
            {
               var_93 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_1002 || this.var_1236 > 0 || this.var_1886;
         this.var_389.alpha = 0;
         if(this.var_1502 > 0)
         {
            _loc13_ = param2 - this.var_1502;
            if(_loc13_ < AvatarAction.const_1068)
            {
               this.var_389.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_389.setExperience(this.var_2381);
               this.var_1236 = this.const_2229;
            }
            else
            {
               this.var_1502 = 0;
            }
            _loc14_ = getSprite(this.const_1946);
            if(_loc14_ != null)
            {
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1053);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1503 != null && this.var_1503 != "")
         {
            param1.appendAction(AvatarAction.const_308,this.var_1503);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1459;
