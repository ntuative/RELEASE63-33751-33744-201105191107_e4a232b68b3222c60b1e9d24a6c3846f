package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1658 = _loc2_;
            this.var_2214 = param1.extra;
            this.var_1107 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1107 > 0 && param1 >= this.var_1107)
         {
            this.var_1107 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1658,String(this.var_1658),this.var_2214);
