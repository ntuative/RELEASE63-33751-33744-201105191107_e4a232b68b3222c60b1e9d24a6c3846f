package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_522,RoomObjectFurnitureActionEvent.const_587,RoomObjectFurnitureActionEvent.const_569,RoomObjectFurnitureActionEvent.const_570];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2174)
         {
            this.var_2174 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_587,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
