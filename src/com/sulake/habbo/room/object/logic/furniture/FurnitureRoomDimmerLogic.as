package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_160,RoomObjectWidgetRequestEvent.const_105,RoomObjectDimmerStateUpdateEvent.const_63];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_2075)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               eventDispatcher.dispatchEvent(_loc3_);
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_105,_loc1_,_loc2_);
