package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureClothingChangeLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_154];
      ...
      private function updateClothingData(param1:String) : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            if(_loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_1189,_loc2_[0]);
            }
            if(_loc2_.length > 1)
            {
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_154,_loc1_,_loc2_);
