package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1768:int = 255;
      
      private var var_1605:uint = 16777215;
      
      private var var_2073:int = 255;
      
      private var var_1325:uint = 16777215;
      
      private var var_2074:int = 255;
      
      private var var_1324:int = 0;
      
      private var var_2072:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_602,RoomObjectMouseEvent.const_144];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1223,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_759,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_979,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_792,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_846,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1324)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1768;
            if(_loc2_ - this.var_1324 >= this.var_2072)
            {
               _loc3_ = this.var_1325;
               _loc4_ = this.var_2074;
               this.var_1324 = 0;
            }
            else
            {
               _loc7_ = this.var_1605 >> 16 & 255;
               _loc8_ = this.var_1605 >> 8 & 255;
               _loc9_ = this.var_1605 & 255;
               _loc10_ = this.var_1325 >> 16 & 255;
               _loc11_ = this.var_1325 >> 8 & 255;
               _loc12_ = this.var_1325 & 255;
               _loc13_ = (_loc2_ - this.var_1324) / this.var_2072;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2073 + (this.var_2074 - this.var_2073) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_759,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_824:
               param2.setString(RoomObjectVariableEnum.const_191,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_841:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_591:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_290)
               {
                  _loc5_ = "null";
               }
               this.var_486.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_829:
               _loc4_ = this.var_486.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_486.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1325,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1271:
               param2.setNumber(RoomObjectVariableEnum.const_979,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1321:
               param2.setNumber(RoomObjectVariableEnum.const_792,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_846,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1076:
               param2.setNumber(RoomObjectVariableEnum.const_1193,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1215:
               param2.setNumber(RoomObjectVariableEnum.const_1213,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1202,int(param1.bgOnly));
         this.var_1605 = this._color;
         this.var_2073 = this.var_1768;
         this.var_1325 = _loc3_;
         this.var_2074 = _loc4_;
         this.var_1324 = getTimer();
         this.var_2072 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_551,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1656,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1913,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1805,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_551,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_284 || _loc12_ == RoomPlaneData.const_374)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
