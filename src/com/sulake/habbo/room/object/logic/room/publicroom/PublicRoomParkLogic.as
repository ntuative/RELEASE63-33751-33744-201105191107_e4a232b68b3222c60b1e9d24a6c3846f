package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1357:String = "goawaybus";
      
      private static const const_1359:String = "bus";
      
      private static const const_1358:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_538,RoomObjectRoomActionEvent.const_624];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1359:
                  case const_1358:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_624,0,_loc4_,_loc5_);
               }
         }
