package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1340:int = 10;
      
      private static const const_993:int = 100;
      
      private static const const_1341:int = 20;
       
      
      private var var_135:HabboMessenger;
      
      private var var_2173:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_135 = param1;
         this.var_1631 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_58 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2173 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_135.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_993 + const_1341)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_135.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1340;
         param1.invalidate();
      }
      ...
      {
         var _loc1_:Conversation = this.var_135.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1631.enable();
         }
         else
         {
            this.var_1631.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_58.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_487.messages.length - const_993);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_135.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_945 || param3.type == Message.const_865 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_135.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_135.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_135.send(new FollowFriendMessageComposer(this.var_487.id));
         this.var_135.send(new ConversionPointMessageComposer("Navigation","IM","go.im"));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_135.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_865)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1211)
         {
            return 4294927974;
         }
