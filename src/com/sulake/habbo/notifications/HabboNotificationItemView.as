package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_572:int = 70;
      
      public static const const_1642:int = 4;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1842 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1842 = 15;
         }
         this.var_1841 = this._window.height;
         this.var_1471 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      {
         if(param1.badgeId != this.var_228.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_596:
               ...
               _loc2_ = Number(this.var_1220) / Number(this.var_972["time_fade_in"]);
               if(this.var_1220 > int(this.var_972["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1030:
               ...
               if(this.var_1472 > int(this.var_972["time_display"]) && !this.var_1843)
               {
                  this.startFadeOut();
               }
               break;
            case const_1031:
               ...
               _loc3_ = 1 - Number(this.var_1221) / Number(this.var_972["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1221 > int(this.var_972["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1842;
         if(this._window.height < this.var_1841)
         {
            this._window.height = this.var_1841;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1642;
         this._window.y = this.var_1471;
      }
