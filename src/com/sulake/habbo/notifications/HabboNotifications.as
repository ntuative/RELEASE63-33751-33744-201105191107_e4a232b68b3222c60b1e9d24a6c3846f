package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1602:String = "pixelbalance";
      
      private static const const_1603:String = "badges";
      
      private static const const_1599:String = "selectbadge";
      
      private static const const_1600:String = "inventory";
      
      private static const const_1604:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1601:String = "friendlist";
      
      private static const const_1597:String = "pet_inventory";
      
      private static const const_1598:String = "go_to_room";
      ...
      private var var_400:HabboNotificationViewManager;
      
      private var var_236:HabboAlertDialogManager;
      
      private var var_856:ParkBusDialogManager;
      
      private var var_2866:Boolean;
      
      private var var_1071:ClubGiftNotification;
      
      private var var_1072:ClubEndingNotification;
      
      private var var_1073:ClubPromoNotification;
      
      private var var_1606:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2076 = false;
         this.var_1606 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1070);
         }
         var _loc6_:Map = this.var_1070["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1070["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_236 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      public function setQuestTrackerVisible(param1:Boolean) : void
      {
         if(this.var_400)
         {
            this.var_400.topMarginIncrease = !!param1 ? 135 : 0;
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1606[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.method_2,assets,this._windowManager,this._localization,this._config,this._communication,this.var_397);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1606[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1606[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onAchievementBonus(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotificationBonus(_loc2_.method_2,_loc2_.realName,assets,this._windowManager,this._localization);
      }
      
      function onAuthenticationOk(param1:IMessageEvent) : void
      {
         this.var_400 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1070["styles"],this.var_1070["view"]);
         ...
         registerUpdateReceiver(this.var_400,1);
         registerUpdateReceiver(this,2);
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_109,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_397.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1274,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1274,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1649,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_923,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_527.createAvatarImage(param2,AvatarScaleType.const_58);
         if(_loc7_ != null)
         {
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_64:
               ...
               break;
            case CatalogPageMessageProductData.const_220:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1144)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1787,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1875)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_1072 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1073 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_400.isSpaceAvailable() && this.var_1326.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_400.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1597:
               if(this.var_13 != null && this.var_13.hasRoomSession)
               {
                  this.var_13.toggleInventoryPage(InventoryCategory.const_129);
               }
               break;
            case const_1604:
               break;
      ...
      {
         if(param1 != null && this.var_400 != null)
         {
            this.var_400.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_346;
            }
            return 1;
         }
         return 1;
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_236 == null)
         {
            return;
         }
         this.var_236.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_236.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_236.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_236.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_236.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_856 == null)
         {
            this.var_856 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_856 != null)
         {
            this.var_856.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1222,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1222,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_527.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_58);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2866)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_923,null);
            this.var_2866 = true;
      ...
      {
         if(param2.type == WindowEvent.const_184 || param2.type == WindowEvent.const_517)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1071 && this.var_1071.visible)
         {
            return;
         }
         this.var_1071 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_923,_loc6_);
      }
   }
}
