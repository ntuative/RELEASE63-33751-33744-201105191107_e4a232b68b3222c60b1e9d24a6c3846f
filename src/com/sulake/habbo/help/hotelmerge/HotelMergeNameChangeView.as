package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_830)
         {
            this.var_830 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_830)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_829)
         {
            this.var_829 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_829)
            {
               return;
            }
