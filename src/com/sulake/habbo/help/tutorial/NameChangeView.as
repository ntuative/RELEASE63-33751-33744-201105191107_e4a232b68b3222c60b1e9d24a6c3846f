package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1955:uint = 11129827;
      ...
      private var var_1956:IWindowContainer;
      ...
      private var var_1262:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1956 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_830)
         {
            this.var_830 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_830)
            {
               return;
            }
            this._window.content.addChild(this.var_830);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_829)
         {
            this.var_829 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_829)
            {
               return;
            }
            this._window.content.addChild(this.var_829);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_829.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_538;
         }
         this.showView(this.var_829);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_538);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1262 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1262.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_538 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_538 != _loc5_)
               {
                  this.var_1957 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_538);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_98);
         }
      }
