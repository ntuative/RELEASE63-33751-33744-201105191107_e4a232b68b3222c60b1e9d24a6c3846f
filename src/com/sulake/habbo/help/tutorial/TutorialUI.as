package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_396:String = "TUI_CLOTHES_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_562,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_515,this.onTaskDoneEvent);
      ...
      {
         return this.var_1217 && this.var_1218 && this.var_1470;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_562,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_515,this.onTaskDoneEvent);
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_45 == null || this.var_45.id == const_98)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_562:
               this.var_1470 = true;
               if(this.var_45 != null && this.var_45.id == const_491)
               {
                  this.showView(const_98);
               }
               break;
            case HabboHelpTutorialEvent.const_515:
               if(this.var_45 != null && this.var_45.id == const_396)
               {
                  this.var_1838 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2444 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2443;
         this._window.width = _loc2_.width + this.var_2444;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_35.hideUI();
         this.var_35.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_118));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_331 || this.var_45.id == const_98))
         {
            this.showView(const_98);
         }
      }
      ...
      {
         this.var_1217 = true;
         if(this.var_45 != null && (this.var_45.id == const_396 || this.var_45.id == const_98))
         {
            this.showView(const_98);
         }
      }
