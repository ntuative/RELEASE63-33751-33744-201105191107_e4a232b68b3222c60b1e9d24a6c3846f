package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1809:String = "HHVE_HELP_FRONTPAGE";
      ...
      {
         this.var_367 = this.var_1809;
         this.var_520 = new Array();
         this.var_624 = new Array();
         super();
         this.var_23 = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105191102));
         this.var_121 = new Map();
         this.var_121.add(HabboHelpViewEnum.const_1853,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_197,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_566,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_326,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_121.add(HabboHelpViewEnum.const_371,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_685,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_258,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_121.add(HabboHelpViewEnum.const_1229,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_121.add(HabboHelpViewEnum.const_1254,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_712,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1809)
         {
            this.var_520 = new Array();
         }
         else if(param2)
         {
            if(this.var_520.length == 0 || param1 != this.var_367)
            {
               this.var_520.push(this.var_367);
            }
         }
         this.var_367 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_367);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_258:
               this.showUI(HabboHelpViewEnum.const_258);
               break;
            case CallForHelpResultEnum.const_1123:
               this.showUI(HabboHelpViewEnum.const_1254);
               break;
            case CallForHelpResultEnum.const_1122:
               this.showUI(HabboHelpViewEnum.const_1229);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_121.getValue(HabboHelpViewEnum.const_197) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_562));
      }
      ...
      {
         return this.var_121.getValue(this.var_367);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2444 = this._window.width - _loc3_.width;
         this.var_2443 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2443;
         this._window.width = _loc1_.width + this.var_2444;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_520.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_197)
         {
            return;
         }
         if(this.var_624.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_624.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_624.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_368.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_624[1],this.var_624[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_624[0],this.var_624[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_367 == HabboHelpViewEnum.const_197 || this.var_520.length == 0)
         {
            return;
         }
         if(this.var_368 == null)
         {
            ...
            this.var_368 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_368.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_368.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_368 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_368 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_368 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
