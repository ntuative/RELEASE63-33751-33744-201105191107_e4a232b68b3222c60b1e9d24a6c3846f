package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_1261:IHabboLocalizationManager;
      
      private var var_1024:IHabboConfigurationManager;
      
      private var var_397:ISessionDataManager;
      
      private var var_1260:FaqIndex;
      ...
      private var var_828:HotelMergeUI;
      
      private var var_1540:CallForHelpData;
      
      private var var_2694:UserRegistry;
      
      private var var_2566:String = "";
      
      private var var_1023:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1540 = new CallForHelpData();
         this.var_2694 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1260 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1261)
         {
            this.var_1261.release(new IIDHabboLocalizationManager());
            this.var_1261 = null;
         }
         if(this.var_247)
         {
            this.var_247.release(new IIDHabboCommunicationManager());
            this.var_247 = null;
         }
         if(this.var_1024)
         {
            this.var_1024.release(new IIDHabboConfigurationManager());
            this.var_1024 = null;
         }
      ...
      {
         if(this.var_247 != null && param1 != null)
         {
            this.var_247.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_1024.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1540.reportedUserId = param1;
         this.var_1540.reportedUserName = param2;
         this.var_66.showUI(HabboHelpViewEnum.const_371);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_828)
         {
            this.var_828 = new HotelMergeUI(this);
         }
         this.var_828.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_108)
         {
            this.var_108.showView(TutorialUI.const_331);
         }
      }
      ...
      {
         this.var_247 = IHabboCommunicationManager(param2);
         this._incomingMessages = new IncomingMessages(this,this.var_247);
      ...
      {
         this.var_1261 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_1024 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_1023)
         {
            this.var_1023 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_1023.showWelcomeScreen(param1);
      }
