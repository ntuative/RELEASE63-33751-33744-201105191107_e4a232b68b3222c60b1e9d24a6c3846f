package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_214:Point;
      
      private var var_2561:WelcomeNotification;
      
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager)
      {
         this.var_214 = new Point(72,10);
         super();
         this.var_181 = param1;
      ...
      public function dispose() : void
      {
         if(this.var_181)
         {
            ...
            this.var_181.toolbar.events.removeEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
            this.var_181 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_181.toolbar.events.addEventListener(HabboToolbarEvent.const_50,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_181.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_214.y = this.var_181.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_214.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_181.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_181.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_214);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_214,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_214.x;
            this._window.y = this.var_214.y;
            this.var_181.removeUpdateReceiver(this);
         }
      }
