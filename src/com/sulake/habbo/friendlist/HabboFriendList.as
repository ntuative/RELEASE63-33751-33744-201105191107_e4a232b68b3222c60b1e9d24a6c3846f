package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_183:String = "face";
      ...
      private var var_2689:FriendListLookAndFeel;
      
      private var var_422:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1947:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_663.stop();
            this.var_663.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_663 = null;
         }
         ...
         if(this.var_135)
         {
            this.var_135.release(new IIDHabboMessenger());
            this.var_135 = null;
         }
         if(this.var_195)
         {
         ...
         if(this.var_1032)
         {
            this.var_1032.release(new IIDAvatarRenderManager());
            this.var_1032 = null;
         }
         if(this.var_903)
         {
         ...
         if(this.var_827)
         {
            this.var_827.release(new IIDSessionDataManager());
            this.var_827 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1947 = new OpenedToWebPopup(this);
         }
         this.var_1947.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_106);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_380);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_355,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1032.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_195.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_195.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_135 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_1133,this.getText("friendlist.friends")));
         this.var_106.addCategory(new FriendCategory(FriendCategory.const_395,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_106.addFriend(new Friend(_loc4_));
         }
         this.var_422 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_663)
         {
            this.var_663 = new Timer(120000);
            this.var_663.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_663.start();
         }
         ...
         {
            _loc5_ = this.var_106.findCategory(FriendCategory.const_395);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_422.findTab(FriendListTab.const_101).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_422.findTab(FriendListTab.const_101);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1946.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_422.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_827 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_827.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_827.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_43))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_183) as IBitmapWrapperWindow;
