package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_370:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_238.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_238[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_238.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
         this.var_238.push(param1);
      }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_238,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1074 >= this.getPageCount())
         {
            this.var_1074 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_238.length / const_370);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1074 * const_370;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1074 + 1) * const_370,this.var_238.length);
      }
