package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2030:int = "F".charCodeAt(0);
      
      public static const const_2139:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1817 = param1.followingAllowed && param1.online;
         this.var_618 = param1.figure;
         this.var_1820 = param1.motto;
         this.var_1819 = param1.lastAccess;
         this.var_1469 = param1.categoryId;
         this.var_1818 = param1.realName;
