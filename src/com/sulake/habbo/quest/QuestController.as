package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable, IUpdateReceiver
   {
      ...
      public function QuestController(param1:HabboQuestEngine)
      {
         ...
         this.var_359 = new QuestTracker(this._questEngine);
         this.var_610 = new QuestsList(this._questEngine);
      ...
      {
         this.var_610.onToolbarClick();
      }
      
      public function onQuests(param1:Array, param2:Boolean) : void
      {
         this.var_610.onQuests(param1,param2);
      }
      
      public function onQuest(param1:QuestMessageData) : void
      {
         this.var_359.onQuest(param1);
      ...
      {
         this.var_359.onQuestCompleted(param1);
      ...
      {
         this.var_359.onRoomEnter();
      }
      
      public function onRoomExit() : void
      {
         this.var_610.onRoomExit();
         this.var_359.onRoomExit();
