package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1382:int = 5;
      ...
      private var var_1150:QuestController;
      
      private var var_912:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1150 = new QuestController(this);
         this.var_912 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1382);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_397.events.removeEventListener(BadgeImageReadyEvent.const_109,this.var_912.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_397.events.addEventListener(BadgeImageReadyEvent.const_109,this.var_912.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_50)
         {
            ...
            {
               this.var_1150.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_912.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1150.questTracker.isVisible();
      }
      ...
      public function setupAchievementCategoryImage(param1:IWindowContainer, param2:AchievementCategory, param3:Boolean) : void
      {
         ...
         var _loc5_:String = !!param3 ? "achmain_" + param2.code + (param2.getProgress() > 0 ? "_active" : "_inactive") : "achicon_" + param2.code;
      ...
      {
         return this.var_195.getKey("questing.enabled","false") == "true";
      }
