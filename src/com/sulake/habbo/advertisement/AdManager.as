package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_247:IHabboCommunicationManager;
      ...
      private var var_1329:BitmapData = null;
      
      private var var_1327:BitmapData = null;
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_181,this.onLoadAdImage);
      }
      ...
      {
         this.var_247 = param2 as IHabboCommunicationManager;
         if(this.var_247 == null)
         {
            return;
         }
         this._connection = this.var_247.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2877 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2876 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2879 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2082 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1328 == 0)
         {
            this.var_1328 = getTimer();
            return false;
         }
         if(this.var_2082 > 0 && this.var_2080 >= this.var_2082)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1328;
         if(_loc1_ > this.var_2876)
         {
            ++this.var_2080;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1608 = _loc2_.imageUrl;
         this.var_2878 = _loc2_.clickUrl;
         this.var_1328 = getTimer();
         if(this.var_1608 != "")
         {
            _loc3_ = this.var_1608;
            ...
            {
               this.var_237 = new Timer(this.var_2879,1);
            ...
            this.var_237.start();
            _loc4_ = new URLRequest(this.var_1608);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_629,0,0,param1.bitmapData,this.var_2878));
            this.var_1328 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_616));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1607 = _loc2_.imageUrl;
         this.var_2081 = _loc2_.clickUrl;
         if(this.var_1607 != "" && this.var_2081 != "")
         {
            _loc3_ = this.var_1607;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1607);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_496,0,0,_loc4_,_loc2_.assetName,this.var_2081,this.var_1329,this.var_1327));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1329 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1327 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_181,param3,param4,param1,param2));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_691.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_691.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_691.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_877,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_691.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_700,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
