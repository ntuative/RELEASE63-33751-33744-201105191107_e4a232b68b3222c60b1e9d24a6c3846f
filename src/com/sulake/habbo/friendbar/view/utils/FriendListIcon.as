package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_1039:int = 200;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1039) : int(const_1038));
         if(!var_878 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_878,!!_hover ? int(const_1039) : int(const_1038));
         if(!var_878 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
