package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_297:Boolean = false;
      
      private static const const_653:String = "Navigation";
      
      private static const const_654:String = "Friend Bar";
      
      private static const const_1485:String = "go.friendbar";
      
      private static const const_1482:String = "chat_btn_click";
      
      private static const const_1481:String = "find_friends_btn_click";
      
      private static const const_1046:String = "Toolbar";
      
      private static const const_1047:String = "open";
      
      private static const const_1048:String = "close";
      
      private static const const_1483:String = "FRIENDLIST";
      
      private static const const_1484:String = "MESSENGER";
       
      
      private var var_90:IHabboCommunicationManager;
      
      private var var_308:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_90)
            {
               this.var_90.release(new IIDHabboCommunicationManager());
               this.var_90 = null;
            }
            if(this.var_308)
            {
               this.var_308.release(new IIDHabboFriendList());
               this.var_308 = null;
            }
            if(this.var_442)
            {
      ...
      {
         return this.var_309.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_90)
         {
            this.var_90.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1485));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_442)
         {
            ...
            if(this.var_90)
            {
               this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1482));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_90)
         {
            this.var_90.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_653,const_654,const_1481));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_308)
         {
            if(!this.var_308.disposed)
            {
               if(!this.var_308.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_308.openFriendRequests();
                  }
                  else
                  {
                     this.var_308.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_308.mainWindow;
               ...
               if(this.var_90)
               {
                  this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1046,const_1483,!!this.var_308.isOpen() ? const_1047 : const_1048));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_442)
         {
            if(!this.var_442.disposed)
            {
               ...
               if(this.var_90)
               {
                  this.var_90.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1046,const_1484,!!this.var_442.isOpen() ? const_1047 : const_1048));
               }
            }
         }
      }
      ...
      {
         this.var_90 = param2 as IHabboCommunicationManager;
         this.var_90.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_90.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_90.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_90.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_90.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_90.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_90.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
      }
      ...
      {
         this.var_308 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_309.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_309.remove(_loc8_);
               this.var_142.splice(this.var_142.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_309.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_297)
               {
               ...
               {
                  this.var_309.remove(_loc4_.id);
                  this.var_142.splice(this.var_142.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_297)
            {
               ...
               this.var_309.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_297)
            {
               if(this.var_309.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_142.push(_loc3_);
                  this.var_309.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_142 = !!const_297 ? this.sortByNameAndOnlineStatus(this.var_142) : this.sortByName(this.var_142);
         }
