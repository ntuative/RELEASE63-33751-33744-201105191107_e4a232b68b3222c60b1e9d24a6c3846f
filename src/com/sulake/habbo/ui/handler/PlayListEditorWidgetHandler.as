package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1392:IMessageEvent;
      
      private var var_1701:IMessageEvent;
      
      private var var_1702:IMessageEvent;
      ...
      {
         this.var_1392 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1701 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1702 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1392);
         this._connection.addMessageEvent(this.var_1701);
         this._connection.addMessageEvent(this.var_1702);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1392);
               this._connection.removeMessageEvent(this.var_1701);
               this._connection.removeMessageEvent(this.var_1702);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_790,RoomWidgetPlayListModificationMessage.const_816,RoomWidgetPlayListModificationMessage.const_847,RoomWidgetPlayListPlayStateMessage.const_701,RoomWidgetPlayListUserActionMessage.const_836];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_790:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_816:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_847:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_701:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_241);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_241:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_898,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_725,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_774));
               break;
