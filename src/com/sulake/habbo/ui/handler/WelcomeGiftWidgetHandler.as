package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_712 = [];
         this.var_712.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_712.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_712)
         {
            return;
         }
         for each(_loc1_ in this.var_712)
