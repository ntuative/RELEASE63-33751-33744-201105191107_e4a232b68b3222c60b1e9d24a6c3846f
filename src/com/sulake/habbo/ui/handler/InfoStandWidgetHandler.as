package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_223.events.addEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_223.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_109,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_107,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_109,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_107,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_633.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_633.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_223 != null)
         {
            this.var_223.events.removeEventListener(NowPlayingEvent.const_100,this.onNowPlayingChanged);
            this.var_223.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_223 = null;
         }
         this.var_1084 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_526);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_982);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_469);
         _loc1_.push(RoomWidgetUserActionMessage.const_793);
         _loc1_.push(RoomWidgetFurniActionMessage.const_267);
         _loc1_.push(RoomWidgetFurniActionMessage.const_984);
         _loc1_.push(RoomWidgetFurniActionMessage.const_767);
         _loc1_.push(RoomWidgetFurniActionMessage.const_742);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1247);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_874);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_699);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_915);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1734);
         _loc1_.push(RoomWidgetPetCommandMessage.const_506);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_601)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_421 || param1.type == RoomWidgetUserActionMessage.const_473 || param1.type == RoomWidgetUserActionMessage.const_619)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_526:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_982:
            ...
            case RoomWidgetUserActionMessage.const_553:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1178,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_597:
               ...
               break;
            case RoomWidgetUserActionMessage.const_469:
            ...
            case RoomWidgetUserActionMessage.const_619:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_984:
            ...
            case RoomWidgetFurniActionMessage.const_267:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_767:
            ...
            case RoomWidgetFurniActionMessage.const_742:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1247:
            ...
            case RoomWidgetUserActionMessage.const_421:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_874:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_699:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_915:
            ...
            case RoomWidgetPetCommandMessage.const_724:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_506:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_245);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_349);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_416) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_416);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_689) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1207;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_245);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1118);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_574)
                  {
                     _loc30_ = this.var_223.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_389) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_389.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_223.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_215)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_157)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_545)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_465);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_131)
               {
                  _loc14_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_136)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_842);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_878;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_921;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1827);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_139];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_139:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_633.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_633.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_842);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_223 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_223.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_422,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_223 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_383,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
