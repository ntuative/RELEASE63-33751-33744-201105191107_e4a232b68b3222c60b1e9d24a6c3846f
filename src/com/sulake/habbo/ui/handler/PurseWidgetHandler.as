package com.sulake.habbo.ui.handler
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_899);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_899:
            ...
            case RoomWidgetOpenCatalogMessage.const_412:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1256:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1797);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1303:
