package com.sulake.habbo.ui.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_93,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_476,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_593,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_488,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_568,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_93,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_476,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_593,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_488,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_568,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_71:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_593:
               if(!this.var_394)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_488:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_568:
               if(!this.var_394)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_476:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_93:
               if(!this.var_394)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(this.var_394 || this.var_217 == -1 || !this._controller)
         {
            return;
         }
         this.var_394 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_178,this.var_217);
