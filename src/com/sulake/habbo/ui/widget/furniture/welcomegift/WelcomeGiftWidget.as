package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1027:String = "welcome_gift_email_verified";
      
      private const const_1417:String = "welcome_gift_email_change";
      
      private const const_2225:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1203)
         {
            this.setViewState(this.const_1027);
         }
         else
         {
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_644:
               ...
               this._view.findChildByName("edit_text").visible = this.var_958;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_958);
               break;
            case this.const_1027:
            ...
            case this.const_1417:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_958);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1465;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1417);
      }
      ...
      {
         this.setViewState(!!this.var_1203 ? this.const_1027 : this.const_644);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1466 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1466));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_477,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_827,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_477,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_827,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_477:
               this.var_1465 = param1.email;
               this.var_1203 = param1.isVerified;
               this.var_958 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1465 = this.var_1466;
            this.setViewState(this.const_644);
         }
         else
         {
            if(param1.result == this.const_2225)
            {
               this.var_958 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1466);
