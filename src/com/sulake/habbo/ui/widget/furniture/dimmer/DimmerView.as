package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1349,const_1347,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_427 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_277 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_277.numTabItems)
         {
            _loc6_ = this.var_277.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_42,true);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1450 = _loc2_.light;
         if(this.var_427 != null)
         {
            this.var_427.setValue(this.var_1450);
         }
         this.var_499 = this.colors.indexOf(_loc2_.color);
         if(this.var_621 != null)
         {
            this.var_621.setSelectedColorIndex(this.var_499);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_277.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_277.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_277.selector.getSelected();
         return this.var_277.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1449 = XML(_loc1_.content);
         return this.var_1449;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_427 != null)
         {
            this.var_427.min = this._widget.minLights[param1 - 1];
         }
      }
