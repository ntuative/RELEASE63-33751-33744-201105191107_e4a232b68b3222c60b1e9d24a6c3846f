package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1967:int = 2;
      
      private const const_1965:int = 3;
      
      private const const_1971:int = 4;
      
      private const const_2239:int = 0;
      
      private const const_2242:int = 1;
      
      private const const_2243:int = 2;
      
      private const const_2235:int = 3;
      
      private const const_2241:int = 4;
      
      private const const_2240:int = 5;
      
      private const const_1970:String = "deco_img";
      
      private const const_1968:String = "dialog_bg";
      
      private const const_2236:String = "%campaign%_dialog_bg.png";
      
      private const const_366:String = "%campaign%_gift_package.png";
      
      private const const_2237:String = "%campaign%_gift_content.png";
      
      private const const_2238:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1565 = this.var_144.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1565 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1567.length)
         {
            _loc2_ = this.var_1567.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_144 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_575,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_887,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_766,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_575,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_575:
               _loc2_ = this.const_1969;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_766:
               _loc4_ = param1.firstClickUserName;
               _loc5_ = param1.method_1;
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_1965;
                     var_63.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
               ...
               {
                  _loc2_ = this.const_1971;
               }
               this._shareId = null;
               this.var_1568 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_887:
               _loc2_ = this.const_1966;
               this.var_217 = param1.objectId;
               this._shareId = param1.data;
               this.var_403 = param1.status;
               this.var_1568 = param1.itemCategory;
               var_63.registerParameter("notifications.viral_furni.fb.title","realname",param1.ownRealName);
               var_63.registerParameter("notifications.viral_furni.fb.desc","realname",param1.ownRealName);
               var_63.registerParameter("widget.furni.teaser.gift.unlocked.desc","username",param1.firstClickUserName);
               break;
            default:
               Logger.log("Error, invalid viral widget update message: " + param1.type);
         }
         if(this._window && (this.var_1566 != _loc2_ || _loc3_ != this.var_191))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_191 = _loc3_;
         this.var_1566 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1566)
            {
               ...
               case this.const_1966:
                  ...
                  else if(this.var_403 == this.const_2242)
                  {
                     ...
                     _loc2_ = this.const_2237;
                  }
                  else if(this.var_403 == this.const_2243)
                  {
                     ...
                     _loc3_ = var_63.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_63.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_366;
                  }
                  else if(this.var_403 == this.const_2235)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.not_enough_fb_friends");
                     _loc3_ = var_63.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_63.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_366;
                  }
                  else if(this.var_403 == this.const_2241)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.not_enough_fb_friends");
                     _loc3_ = var_63.getKey("widget.furni.teaser.gift.no_min_fb_friends.title");
                     _loc4_ = var_63.getKey("widget.furni.teaser.gift.no_min_fb_friends.desc");
                     _loc2_ = this.const_366;
                  }
                  else if(this.var_403 == this.const_2240)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.campaign_closed");
                     _loc3_ = var_63.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                     _loc4_ = var_63.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
                     _loc2_ = this.const_366;
                  }
                  break;
               case this.const_1967:
                  _loc1_ = assets.getAssetByName("notification_gift_received") as XmlAsset;
                  _loc2_ = this.const_2238;
                  break;
            ...
            _loc5_ = this.const_2236.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc5_,this.const_1968);
            _loc2_ = _loc2_.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc2_,this.const_1970);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_962);
      ...
      {
         var _loc2_:String = var_63.getKey("notifications.viral_furni.fb.title");
         var _loc3_:String = var_63.getKey("notifications.viral_furni.fb.desc");
         this.sendConversionPoint("viral_" + this.var_191,"client.start_post",this._shareId);
         var _loc4_:String = this.var_144.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1568 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1568 == 1 ? "null" : InventoryCategory.const_129);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_963,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1567.push(new ImageDownloader(this,_assets,this.var_191,this.var_1565,param1,param2));
            return;
         }
