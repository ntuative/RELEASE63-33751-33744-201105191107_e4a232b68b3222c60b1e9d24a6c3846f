package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2138 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_495,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_495,this.onEditPostItRequest);
      }
      ...
      {
         hideInterface(false);
         var_217 = param1.objectId;
         this.var_431 = param1.location;
         var_1343 = param1.objectType;
         _text = "";
         var_333 = "FFFF33";
         _controller = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_217 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_799,var_217,this.var_431,_text,var_333);
