package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1337:uint = 0;
      
      protected static const const_361:uint = 1;
      
      protected static const const_986:uint = 2;
      
      protected static var var_1363:uint = const_361;
      
      private static const const_1410:uint = 4281149991;
      
      private static const const_1411:uint = 4283715916;
      
      private static const const_1412:uint = 16777215;
      
      private static const const_1414:uint = 9552639;
      
      private static const const_1415:uint = 16744755;
      
      private static const const_1413:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_336:uint = 1;
      
      protected var var_1347:Boolean;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1347)
         {
            ...
            {
               this.var_336 = const_986;
            }
            else
            {
               this.var_336 = var_1363;
            }
         }
         if(this.var_336 == const_1337)
         {
         ...
         if(this.var_336 == const_1337 || this.var_336 == const_361)
         {
            ...
            else
            {
               ...
               this.var_336 = const_361;
            }
         }
         if(this.var_336 == const_361)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == "button")
            {
               param2.color = const_1410;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1412;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
