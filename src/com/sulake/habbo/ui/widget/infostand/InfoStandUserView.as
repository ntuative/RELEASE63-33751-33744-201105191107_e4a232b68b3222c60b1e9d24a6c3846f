package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_908:TagListRenderer;
      
      private var var_140:IBorderWindow;
      
      private var var_2449:int;
      
      private var var_2450:Boolean = true;
      
      private const const_1022:int = 5;
      
      private const const_2222:int = 3;
      
      private const const_1408:int = 11184810;
      
      private const const_1407:int = 16777215;
      
      private const const_2221:int = 2000;
      
      private const const_2223:int = 50;
      
      private const const_2224:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_908 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2450 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      {
         if(this.var_51 == null || this.var_47 == null || this.var_99 == null)
         {
            return;
         }
         this.var_51.height = this.var_51.scrollableRegion.height;
         this.var_47.height = this.var_51.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_99.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_99.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         if(this.var_47 != null)
         {
            this.var_51 = this.var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc9_:IWindowContainer = this.var_51.getListItemByName("motto_container") as IWindowContainer;
         if(_loc9_)
         {
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_140.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_140.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_140.x = _loc5_.left - this.var_140.width;
         this.var_140.y = _loc5_.top + (_loc5_.height - this.var_140.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_140.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_140.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_140.x = _loc7_.left - this.var_140.width;
         this.var_140.y = _loc7_.top + (_loc7_.height - this.var_140.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_140 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_140 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1022;
      ...
      {
         var _loc3_:IWindowContainer = this.var_51.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:ITextWindow = _loc3_.findChildByName("motto_text") as ITextWindow;
         var _loc5_:IWindowContainer = this.var_51.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc4_.textColor = this.const_1408;
            }
            else
            {
               _loc4_.textColor = this.const_1407;
            }
            _loc4_.enable();
         }
         else
         ...
         _loc4_.text = param1;
         _loc4_.height = Math.min(_loc4_.textHeight + this.const_1022,this.const_2223);
         _loc4_.height = Math.max(_loc4_.height,this.const_2224);
         _loc3_.height = _loc4_.height + this.const_2222;
         if(param2)
         {
            _loc4_.addEventListener(WindowKeyboardEvent.const_316,this.onMottoKeyboard);
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc4_.removeEventListener(WindowKeyboardEvent.const_316,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_908.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_131);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_878:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_921:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:IWindowContainer = this.var_51.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2449 > this.const_2221 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2449 = _loc6_;
               _loc3_.textColor = this.const_1407;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1408;
         }
      }
