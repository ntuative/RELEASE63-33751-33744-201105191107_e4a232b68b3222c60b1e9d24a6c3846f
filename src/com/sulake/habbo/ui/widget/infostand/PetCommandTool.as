package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1533:Point = new Point(100,30);
      ...
      private const const_2247:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_399 = new Timer(this.const_2247);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         if(_loc6_ == null)
         {
            ...
            this.requestEnabledCommands(this.var_559);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1307.getValue(this.var_559) as CommandConfiguration;
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.position = const_1533;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_467 == null)
         {
            ...
            this.var_467 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_467 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_467.x = 200;
            this.var_467.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_421,this.var_559));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_506,this.var_559,this.var_2045 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_506,this.var_559,this.var_2045 + " " + _loc5_);
