package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_422)
         {
            this.var_1652 = param1.songId;
         }
         if(param1.songId == this.var_1652)
         {
            this._songName = param1.songName;
            this.var_2208 = param1.songAuthor;
            this.updateNowPlaying(this.var_1652 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2208;
         }
         else
         {
