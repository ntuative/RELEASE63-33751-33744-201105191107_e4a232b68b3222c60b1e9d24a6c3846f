package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1578:int = 152;
      
      private static const const_1573:int = 16;
      
      private static const const_671:int = 4;
      
      private static const const_1584:uint = 14342874;
      
      private static const const_1575:uint = 3815994;
      
      private static const const_1579:uint = 2085362;
      
      private static const const_1577:uint = 39616;
      
      private static const const_1572:uint = 10513106;
      
      private static const const_1580:uint = 8734654;
      
      private static const const_1581:uint = 9094430;
      
      private static const const_1576:uint = 6200576;
      
      private static const const_1582:String = "happiness";
      
      private static const const_1583:String = "experience";
      
      private static const const_1574:String = "energy";
      
      private static const const_1571:int = 250;
      
      private static const const_1090:int = 25;
      
      private static const const_1089:int = 5;
      ...
      private var var_215:PetCommandTool;
      ...
      private function updateWindow() : void
      {
         ...
         this.var_99.width = this.var_99.width;
         this.var_99.visible = this.var_99.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1582,param1.nutrition,param1.nutritionMax,const_1577,const_1579);
         this.updateStateElement(const_1583,param1.experience,param1.experienceMax,const_1580,const_1572);
         this.updateStateElement(const_1574,param1.energy,param1.energyMax,const_1576,const_1581);
         ...
         this.updateWindow();
         this.var_559 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_215 && this.var_215.isVisible() && param1.isOwnPet)
         {
            this.var_215.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_215.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1578,const_1573,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1584);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1575);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_671,_loc7_.width - 2,_loc7_.height - 2 - const_671);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_671);
      ...
      private function openTrainView() : void
      {
         if(this.var_215 == null)
         {
            this.var_215 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_559) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_215.showWindow(true);
            this.var_215.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_99.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_215 && this.var_215.getPetId() == this.var_559)
               {
                  this.var_215.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_382,this._widget.petData.ownerId);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1571;
         this.var_99.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1090 + const_1089;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1089;
            }
         }
         this.var_99.height = _loc4_ + const_1090;
         this.updateWindow();
      }
   }
}
