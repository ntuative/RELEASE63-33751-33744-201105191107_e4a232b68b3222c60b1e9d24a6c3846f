package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1741:IWindow;
      
      private var _button:IWindow;
      
      private var var_1740:IWindow;
      
      private var var_1422:IWindow;
      ...
      private const const_2211:int = 250;
      
      private const const_2209:int = 0;
      
      private const const_2210:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1161 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2340 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2341 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1741 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1740 = this._window.findChildByName("send_button_text");
         this.var_1422 = this._window.findChildByName("block_text");
         this.var_1740.caption = this.const_2210;
         this.var_25.setParamFlag(HabboWindowParam.const_42,true);
         this.var_25.addEventListener(WindowMouseEvent.const_45,this.windowMouseEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_316,this.keyUpHandler);
         this.var_25.addEventListener(WindowEvent.const_108,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1423 = true;
         this.var_605 = "";
         this._window.addEventListener(WindowEvent.const_801,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_467,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1741.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2211 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2209);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1161 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_605 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_605.length + 1)
            {
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_133);
