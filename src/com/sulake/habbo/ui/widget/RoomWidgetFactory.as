      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_426:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_63,this.var_144,this.var_2423++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_384:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_63,this.var_144,this);
               break;
            case RoomWidgetEnum.const_599:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_63,this.var_144,this._catalog);
               break;
            case RoomWidgetEnum.const_540:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_63,events,this.var_144);
               break;
            ...
            case RoomWidgetEnum.const_605:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_63,this.var_144,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_623:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_63,this.var_144);
               break;
            case RoomWidgetEnum.const_678:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_63,this.var_144);
               break;
            case RoomWidgetEnum.const_132:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_63,this.var_144);
               break;
            ...
            case RoomWidgetEnum.const_125:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_144,this.var_63,this);
               break;
            ...
            case RoomWidgetEnum.const_519:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_63,this.var_144,this._catalog);
               break;
