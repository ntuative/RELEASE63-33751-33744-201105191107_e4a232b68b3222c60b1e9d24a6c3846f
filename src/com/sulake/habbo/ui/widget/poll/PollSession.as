package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1193:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_258 = new PollOfferDialog(this._id,param1,this.var_1193);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_258 = new PollContentDialog(this._id,param1,param3,this.var_1193);
      }
      ...
      {
         this.var_1193.windowManager.alert("${poll_thanks_title}",this.var_2038,0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
