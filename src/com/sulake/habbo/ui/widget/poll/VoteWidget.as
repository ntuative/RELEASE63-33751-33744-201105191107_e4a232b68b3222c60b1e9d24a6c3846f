package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1492:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1492 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_167.reset();
            this.var_167.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_167 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_149,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_152,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_149,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_152,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_167 = new Timer(1000);
            this.var_167.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
         this.var_1873 = getTimer();
         this.var_167.reset();
         this.var_167.start();
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1492 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1873;
         if(_loc2_ > this.var_1492)
         {
            this.vote();
            return;
         }
