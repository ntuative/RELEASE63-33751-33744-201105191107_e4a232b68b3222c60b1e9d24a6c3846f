package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_870:String = "PLSV_ADD_SONGS";
      
      public static const const_1258:String = "PLSV_START_PLAYBACK";
      
      public static const const_485:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_485)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_443[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_443[const_870];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_443.add(const_485,_loc1_);
