package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1522:int = 130;
      
      private static const const_1527:int = 100;
      
      private static const const_1523:int = 130;
      
      private static const const_1525:int = 100;
      
      private static const const_1524:int = 130;
      
      private static const const_1526:int = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_898,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_725,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_774,this.onSongDiskInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_102,this.onPlayListUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_167,this.onPlayListFullEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_100,this.onNowPlayingChangedEvent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_898,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_725,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_774,this.onSongDiskInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_102,this.onPlayListUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_167,this.onPlayListFullEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_100,this.onNowPlayingChangedEvent);
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1527 + const_1522);
         _loc3_ = uint(_loc3_ % const_1525 + const_1523);
         _loc4_ = uint(_loc4_ % const_1526 + const_1524);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_816,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_847,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_701,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this._soundManager.musicController.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_134);
         if(_loc2_ != -1)
         {
      ...
      {
         var _loc2_:String = this.var_195.getKey("image.library.playlist.url");
      ...
      public function openSongDiskShopCataloguePage() : void
      {
         ...
         this._catalog.openCatalogPage(CatalogPageName.const_1793,true);
      }
