package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_667:IItemGridWindow;
      
      private var _items:Map;
      
      private var _widget:PlayListEditorWidget;
      
      private var var_104:MusicInventoryGridItem;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_667.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_1204;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_104 != null)
         {
            this.var_104.playButtonState = MusicInventoryGridItem.const_607;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_151;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_to_playlist" || _loc3_)
            {
               if(this.var_104 != null)
               {
                  this.var_104.deselect();
                  this.stopPreview();
                  this._widget.sendAddToPlayListMessage(this.var_104.diskId);
                  this.var_104 = null;
               }
            }
            else if(param2.name == "button_play_pause")
            {
               if(this.var_104.playButtonState == MusicInventoryGridItem.const_607)
               {
                  this.var_104.playButtonState = MusicInventoryGridItem.const_1125;
                  this._widget.playUserSong(this.var_104.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_667.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
                  _loc5_ = this._items.getWithIndex(_loc4_);
                  if(_loc5_ != this.var_104)
                  {
                     if(this.var_104 != null)
                     {
                        this.var_104.deselect();
