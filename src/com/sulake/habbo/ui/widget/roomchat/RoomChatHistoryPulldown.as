package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1016:int = 150;
      
      private static const const_1017:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2411 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1790 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2410 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1791 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1792 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2413 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2409 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_77 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_355,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_84),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_77);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_41.height - const_84,param3.width,const_84),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_554,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_84),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_596:
               this.var_77.blend += param1 / const_1017;
               this._window.blend += param1 / const_1017;
               ...
               break;
            case const_1031:
               this.var_77.blend -= param1 / const_1016;
               this._window.blend -= param1 / const_1016;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_41.width - this.var_2412;
         }
         if(this.var_77 != null)
         {
            this.var_77.rectangle = this.var_41.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2414 == this._window.width)
         {
            return;
         }
         this.var_2414 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2410;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1791;
            barX.disposesBitmap = false;
            this.var_2412 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2411,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1790,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1790,destGripRBitmap);
         ...
         this.var_77.bitmap = this.var_2409;
