package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1939:MeMenuSoundSettingsView;
      ...
      private var var_1214:Number = 1.0;
      ...
      {
         return int(this.var_1636 * (Number(param1 - this._minValue) / (this.var_1214 - this._minValue)));
      }
      
      private function getValue(param1:Number) : Number
      {
         return param1 / this.var_1636 * (this.var_1214 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1939.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_708 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_708.width,this.var_708.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_708,this.var_708.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_709 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_709.width,this.var_709.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_709,this.var_709.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1636 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
