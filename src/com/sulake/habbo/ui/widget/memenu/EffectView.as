package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2220:int = 1000;
      ...
      private var var_948:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_200 = new Timer(this.const_2220);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_183.isActive)
         {
            ...
            this.var_949.width = _loc2_ * this.var_298;
         }
         else
         {
            this.var_949.width = 0;
            this.var_200.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_772 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_772 == null)
            {
               return;
            }
         ...
         if(!this.var_183.isActive)
         {
            this.var_772.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_772.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_772.text;
         var _loc2_:int = this.var_183.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_948 = this._window.findChildByName("effect_hilite");
            this.var_948.visible = false;
         }
         this.setTimeLeft();
         this.var_949 = this._window.findChildByName("loader_bar");
         if(this.var_949 != null)
         {
            this.var_298 = this.var_949.width;
            this.var_200.start();
            this.onUpdate();
         }
