package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_943:MeMenuSoundSettingsSlider;
      ...
      private var var_944:BitmapData;
      ...
      {
         this.var_905 = param1.volume;
         if(this.var_943 != null)
         {
            this.var_943.setValue(this.var_905);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_941 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_940 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_942 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_944 = (_loc5_.content as BitmapData).clone();
         }
         this.var_943 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_784));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_905 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_944);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_941);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_942);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_940);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_840);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_805);
         }
