package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1202:SliderWindowController;
      
      private var var_1201:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2126;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1202.getValue());
         _loc2_.push(this.var_1201.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_83 = param2;
         this.var_1202 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1202.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1202.setValue(1);
         this.var_1201 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1201.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1201.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1202.setValue(_loc3_);
         this.var_1201.setValue(_loc4_);
      }
      ...
      private function onMinSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               _loc4_ = int(_loc3_);
               this.var_83.localization.registerParameter("wiredfurni.params.usercountmin","value","" + _loc4_);
            }
         }
      }
      ...
      private function onMaxSliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               _loc3_ = _loc2_.getValue();
               _loc4_ = int(_loc3_);
               this.var_83.localization.registerParameter("wiredfurni.params.usercountmax","value","" + _loc4_);
            }
         }
      }
   }
