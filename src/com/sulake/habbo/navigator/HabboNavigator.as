package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_687:RoomInfoViewCtrl;
      ...
      private var var_886:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_687 = new RoomInfoViewCtrl(this);
         this.var_1319 = new RoomCreateViewCtrl(this);
         this.var_2230 = new RoomThumbnailRenderer(this);
         this.var_886 = new GuestRoomPasswordInput(this);
         this.var_328 = new GuestRoomDoorbell(this);
         this.var_422 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_355,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_195.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_324.startSearch(Tabs.const_216,Tabs.const_398,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_324.startSearch(Tabs.const_247,Tabs.const_275);
         this.var_422.getTab(Tabs.const_247).tabPageDecorator.tabSelected();
      }
