package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1165:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_608 = new Timer(100);
         this.var_608.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,80,"g"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,74,"h"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,416,"o"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,352,"p"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,304,"q"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,336,"r"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,748,"u"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_608)
         {
            this.var_608.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_608.reset();
            this.var_608 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1165.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1746 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1746 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_58 = IItemListWindow(this.var_180.findChildByName("item_list"));
         ...
         this.var_1166 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_180.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1166.goBackToInitialState();
         this.var_1166.input.textBackgroundColor = 4294967295;
         this.var_1165 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_43))
         {
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         _loc6_.setParamFlag(HabboWindowParam.const_42,false);
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_56:
               return true;
            case HabboClubLevelEnum.const_43:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_43);
            case HabboClubLevelEnum.const_47:
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1166.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1166.getText();
         var _loc3_:String = "model_" + this.var_1165.name;
