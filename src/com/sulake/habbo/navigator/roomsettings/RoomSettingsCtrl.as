package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1116:TextFieldManager;
      
      private var var_1117:ICheckBoxWindow;
      
      private var var_1119:ICheckBoxWindow;
      
      private var var_1115:ICheckBoxWindow;
      
      private var var_720:ICheckBoxWindow;
      
      private var var_1673:ITextWindow;
      
      private var var_888:IDropMenuWindow;
      ...
      {
         this.var_345 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_345));
         if(this.var_1113 != null)
         {
            this.var_1113.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_345)
         {
            return;
         }
         this.var_75 = param1;
      ...
      {
         if(param1 != this.var_345 || this.var_1114 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1114 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1821)
         {
            this.var_722.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1658)
         {
            this.var_722.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1770)
         {
            this.var_1118.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1876)
         {
            this.setTagError(this.var_884,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_885,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1835)
         {
            this.setTagError(this.var_884,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_885,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1794)
         {
            this.var_886.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_722.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_722.clearErrors();
         this.var_1118.clearErrors();
         this.var_884.clearErrors();
         this.var_885.clearErrors();
         this.var_886.clearErrors();
         this.var_1116.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_352,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_462,this.onDoorModePasswordUnselect);
         ...
         this.var_722 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1118 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_884 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_885 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_886 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1116 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1117 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1119 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1115 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_720 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1673 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_888 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_887 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2222 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1121 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1120 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1671 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1377 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_246 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1113 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1379 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1379.mouseThreshold = 0;
         this.var_1379.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1113.visible = false;
         if(!this.var_1378)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1671.visible = this.var_1378;
         if(this.var_721)
         {
         ...
         {
            this.populateForm();
            this.var_1121.visible = true;
            this.var_1377.visible = true;
            this.var_2222.visible = this.var_1378;
            this.var_1121.height = Util.getLowestPoint(this.var_1121) + 4;
         }
         this.var_1379.text = !!this.var_721 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1121.name,this.var_1120.name,this.var_1377.name,this.var_1671.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_722.setText(_loc1_.name);
         this.var_1118.setText(_loc1_.description);
         this.var_886.setText("");
         this.var_1116.setText("");
         ...
         this.setTag(this.var_884,_loc1_.tags[0]);
         this.setTag(this.var_885,_loc1_.tags[1]);
         if(this.var_1117)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1119)
         {
            ...
            {
               this.var_1119.select();
            }
            else
            {
               this.var_1119.unselect();
            }
         }
         if(this.var_1115)
         {
         ...
         {
            this.disableWindow(this.var_720);
            this.disableWindow(this.var_888);
            this.disableWindow(this.var_887);
            this.disableWindow(this.var_1673);
         }
         else
         {
            this.enableWindow(this.var_720);
            this.enableWindow(this.var_888);
            this.enableWindow(this.var_887);
            this.enableWindow(this.var_1673);
         }
         if(this.var_720)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_720.unselect();
            }
         }
         if(this.var_888)
         {
            this.var_888.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_887)
         {
            this.var_887.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_722.getText();
         _loc2_.description = this.var_1118.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_529;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_123)
         {
            _loc8_ = this.var_886.getText();
            _loc9_ = this.var_1116.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_886.clearErrors();
               this.var_1116.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1117.isSelected;
         _loc2_.allowFoodConsume = this.var_1119.isSelected;
         _loc2_.allowWalkThrough = this.var_1115.isSelected;
         _loc2_.hideWalls = this.var_720.isSelected;
         _loc2_.wallThickness = this.var_888.selection - 2;
         _loc2_.floorThickness = this.var_887.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_884,_loc2_.tags);
         this.addTag(this.var_885,_loc2_.tags);
         this.clearErrors();
         this.var_1114 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_345);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_345]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_246.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_246.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_246.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_246.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_246.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_246.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_246.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_246);
         this.var_246.findChildByName("ruler").visible = true;
         ...
         if(this.var_75.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_246,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_80,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      private function method_8() : Boolean
      {
         var _loc1_:* = null;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_345));
      }
