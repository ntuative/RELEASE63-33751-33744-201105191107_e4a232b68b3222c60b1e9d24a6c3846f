package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_691:int = 2;
      
      public static const const_2118:int = 3;
      ...
      private var var_931:PopularTagsListCtrl;
      
      private var var_930:GuestRoomListCtrl;
      
      private var var_1174:OfficialRoomListCtrl;
      ...
      private var var_1435:IWindow;
      
      private var var_763:IRegionWindow;
      ...
      private var var_764:WindowToggle;
      
      private const const_1933:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_931 = new PopularTagsListCtrl(this._navigator);
         this.var_930 = new GuestRoomListCtrl(this._navigator);
         this.var_1174 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_764 || this.var_764.disposed)
         {
            this.var_764 = new WindowToggle(this.var_17,this.var_17.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_764.toggle();
      ...
      private function prepare() : void
      {
         ...
         this.var_180 = IWindowContainer(this.var_17.findChildByName("tab_content"));
         ...
         this.var_1435 = this.var_17.findChildByName("loading_text");
         ...
         this.var_763 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(this.var_763 != null)
         {
            this.var_763.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onHotelViewMouseOver);
            this.var_763.addEventListener(WindowMouseEvent.const_25,this.onHotelViewMouseOut);
            this.var_763.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onHotelViewMouseClick);
         }
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1763,true);
         this.var_17.position = this.const_1933;
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_180,["custom_content","list_content"],this.var_222.y,8);
         this.var_199.height = this.var_199.height + _loc1_ - this.var_199.y - this.var_256.height + this.var_2373;
         Util.moveChildrenToColumn(this.var_180,["list_content","custom_footer"],this.var_199.y,0);
         this.var_2373 = this.var_256.height;
      ...
      {
         this.refreshList(param1,param2,this.var_930,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_931,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1174,"official_rooms");
      }
      ...
      private function getSearchMsg(param1:int, param2:String) : IMessageComposer
      {
         ...
         if(param1 == Tabs.const_435)
         {
            return new PopularRoomsSearchMessageComposer(param2,this._navigator.data.adIndex);
         }
         if(param1 == Tabs.const_928)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_616 == const_1014)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_199.blend - _loc2_));
            this.var_199.blend = _loc3_;
            this.var_222.blend = !!this.var_1173 ? Number(_loc3_) : Number(1);
            this.var_256.blend = !!this.var_1173 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_616 = const_641;
            }
         }
         else if(this.var_616 == const_641)
         {
            if(this.var_1436 % 10 == 1)
            {
               this.var_1435.visible = !this.var_1435.visible;
            }
            ++this.var_1436;
            if(!this._navigator.data.isLoading())
            {
               this.var_616 = const_1015;
            }
         }
         else if(this.var_616 == const_1015)
         {
            this.refresh();
            this.var_616 = const_1399;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_931);
         this.refreshScrollbar(this.var_930);
      }
      ...
      {
         this._navigator.refreshButton(this.var_763,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_763,"icon_hotelview_reactive",param1,null,0);
      }
