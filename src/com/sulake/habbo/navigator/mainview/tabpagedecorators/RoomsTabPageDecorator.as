package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_148 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_435);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_925);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_435,"" + _loc3_);
         }
         if(this.var_148)
         {
            this._navigator.trackNavigationDataPoint(this.var_148.enumerateSelection()[this.var_148.selection],"category.view");
         }
      }
