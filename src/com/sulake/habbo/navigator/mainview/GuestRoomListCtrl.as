package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_571 = IScrollbarWindow(this.var_180.findChildByName("scroller"));
      }
      ...
      private function method_4(param1:int) : IWindowContainer
      {
         var _loc2_:IWindowContainer = IWindowContainer(this._navigator.getXmlWindow("grs_guest_room_details_short"));
         _loc2_.background = true;
         _loc2_.addEventListener(WindowMouseEvent.const_206,this.onMouseMove);
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_42,true);
         _loc2_.setParamFlag(HabboWindowParam.const_1681,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_212,null,0);
      ...
      private function onMouseOver(param1:WindowEvent) : void
      {
         ...
         if(this.var_496.visible && this.var_2295)
         {
            return;
         }
         ...
         if(_loc4_.ownerName != this._navigator.sessionData.userName)
         {
            ...
            switch(_loc4_.doorMode)
            {
               case RoomSettingsFlatInfo.const_123:
                  ...
                  return;
               case RoomSettingsFlatInfo.const_212:
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1399.tags[0];
            this.var_1399.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2296 - _loc2_.stageX);
         this.var_2296 = _loc2_.stageX;
         this.var_2295 = _loc3_ > 2;
      }
   }
}
