package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2232:String = "hd-99999-99999";
      ...
      private var var_831:PaletteManager;
      ...
      private var var_1960:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_336 = RenderMode.const_1915;
         ...
         this.var_109.add(AvatarType.const_119,_loc4_);
         ...
         this.var_831 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_230)
         {
            this.var_230.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_318.init();
         this.var_831.init();
         _loc2_ = this.var_109.getValue(AvatarType.const_119) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_109.getValue(AvatarType.const_119) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_230 == null)
               {
                  ...
                  this.var_230 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_230.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1013)
         {
            if(this.var_2702 && this.var_2703 && this.var_2704)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_230.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_230.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_109.getValue(AvatarType.const_119) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_230.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1960)
         {
            this.var_1960 = new AvatarFigureContainer(this.const_2232);
         }
         this.var_230.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1960,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_319.getKeys())
         {
            _loc4_ = this.var_319.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1742)
         {
         ...
         if(param5 != null)
         {
            ...
            this.var_319.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_319.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_319.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_109.getValue(AvatarType.const_119) as AvatarStructure;
