package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1456:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1457:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_827:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1234:AvatarEditorHandler;
      ...
      private var var_991:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            _loc2_.loadAvatarData(const_1456,FigureData.const_77);
            _loc3_.loadAvatarData(const_1457,FigureData.FEMALE);
            this.var_106 = new Map();
            this.var_528 = new Map();
            this.var_106.add(AvatarEditorFigureCategory.const_843,new BodyModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_52,new HeadModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_260,new TorsoModel(this));
            this.var_106.add(AvatarEditorFigureCategory.const_888,new LegsModel(this));
            ...
            this.var_528.add(AvatarEditorSideCategory.const_111,new WardrobeModel(this));
            this.var_528.add(AvatarEditorSideCategory.const_590,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_991.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_991.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_267 == null)
            {
               this.var_267 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_80,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_267.addChild(this._view.window);
               if(param5)
               {
                  this.var_267.center();
               }
            ...
            this.var_267.visible = !this.var_267.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_843);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_528.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_827 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_527 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_991 = this.var_527.getFigureData(AvatarType.const_119);
      ...
      private function method_6(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1234 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_643[this.var_933];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1501 != null)
         {
            ...
            this.var_1501.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1882;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1233 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1455)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1614.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_527.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_527.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1339.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1806)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1233 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1339.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1233 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_528.getValue(AvatarEditorSideCategory.const_111);
      }
