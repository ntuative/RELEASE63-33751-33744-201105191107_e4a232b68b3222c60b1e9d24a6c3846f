package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_618:AvatarFigureContainer;
      
      private var var_606:Boolean;
      
      private var var_212:Array;
      
      private var var_567:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_618 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_618.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1511 = this.var_1219;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            if((this.var_92 == 6 || this.var_92 == 0) && param2 == 7)
            {
               param2 = this.var_92;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1511);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_607);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_618,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1511 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_607);
                  _loc20_ = this.var_92;
                  _loc21_ = 1;
                  switch(this.var_92)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_92 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_92 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_92 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_92 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_607);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_618,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_92)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_607);
                  _loc21_ = this.var_92;
                  _loc22_ = 1;
                  switch(this.var_92)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_92 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_92 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_92 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_92 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_507 = this.var_507 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_408:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1848:
                  case AvatarAction.const_1798:
                  case AvatarAction.const_1846:
                  case AvatarAction.const_1292:
                  case AvatarAction.const_1137:
                  case AvatarAction.const_1814:
                  case AvatarAction.const_1860:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1001);
         this.getCache().resetBodyPartCache(this.var_1001);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1510 = this._structure.sortActions(this.var_334);
         ...
         {
            this.var_730 = this._structure.getCanvasOffsets(this.var_1510,this._scale,this.var_92);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1510)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_414)
               {
                  this.var_1002 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_234)
               {
                  this.var_1002 = true;
               }
