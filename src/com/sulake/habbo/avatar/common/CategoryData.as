package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2249:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_261)
         {
            for each(_loc2_ in this.var_261 as Array)
            {
               if(_loc2_)
               {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_261 || this.var_261.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_261[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_261.length <= param1)
         {
            return null;
         }
         return this.var_261[param1] as Array;
      }
