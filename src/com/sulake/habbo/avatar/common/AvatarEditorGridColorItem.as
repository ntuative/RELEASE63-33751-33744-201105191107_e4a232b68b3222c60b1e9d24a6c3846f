package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_915:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_613.width,this.var_613.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_613,this.var_613.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_925.width,this.var_925.height,true,0);
            _loc5_ = this.var_925.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_915.colorTransform);
            ...
            if(this.var_915)
            {
               switch(this.var_915.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_677;
                     _loc4_.visible = true;
               }
            }
            else
