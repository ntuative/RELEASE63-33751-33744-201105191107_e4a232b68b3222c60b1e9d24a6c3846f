package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1389:String = "Default";
      
      private static const const_1388:int = 2;
      
      private static const const_1390:String = AvatarSetType.const_35;
      ...
      protected var var_1084:Boolean;
      
      protected var var_730:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_272:AvatarImageCache;
      
      protected var var_618:AvatarFigureContainer;
      
      protected var var_567:IAvatarDataContainer;
      
      protected var var_334:Array;
      
      protected var var_46:BitmapData;
      
      private var var_1001:IActiveActionData;
      ...
      protected var var_1345:Boolean = false;
      ...
      private var var_2343:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1390,const_1388);
         this.var_334 = new Array();
         this.var_1001 = new ActiveActionData(AvatarAction.const_433);
         this.var_1001.definition = this._structure.getActionDefinition(const_1389);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1084)
         {
            ...
            if(this.var_748)
            {
               for each(_loc2_ in this.var_748)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_618,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1743;
         if(param2 < AvatarDirectionAngle.const_1163)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_607,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_253.length == 1 && this.var_92 == this.var_1961)
         {
            return this.var_92 + this.var_507 + this.var_607 % 4;
         }
         if(this.var_253.length == 2)
         {
            for each(_loc1_ in this.var_253)
            {
               ...
               {
                  return this.var_92 + this.var_507 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_607 % 11;
                  return this.var_92 + "_" + this.var_1961 + this.var_507 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2345 || param2 != this.var_2344 || param1 != this.var_2343)
         {
            this.var_2345 = param3;
            this.var_2344 = param2;
            this.var_2343 = param1;
            this.var_1742 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_285.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1345 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1345)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_285.definition.geometryType,this.var_92);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_607);
         ...
         {
            if(this.var_567.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_567.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_285.definition.geometryType,this.var_92);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_607);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
         ...
         switch(param1)
         {
            ...
            case AvatarAction.const_308:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_505:
                  case AvatarAction.const_772:
                     this.addActionData(_loc3_);
                     break;
                  default:
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_334.push(new ActiveActionData(param1,param2,this.var_607));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_285 = this.var_1001;
         this.var_285.definition = this.var_1001.definition;
         this.resetBodyPartCache(this.var_1001);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_507 = "";
         this.var_253 = this._structure.sortActions(this.var_334);
         if(this.var_253 == null)
         {
            this.var_730 = new Array(0,0,0);
            if(this.var_1163 != "")
            {
               _loc1_ = true;
               this.var_1163 = "";
         ...
         {
            this.var_730 = this._structure.getCanvasOffsets(this.var_253,this._scale,this.var_92);
            for each(_loc4_ in this.var_253)
            {
               this.var_507 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_348)
               {
            ...
            if(this.var_1163 != this.var_507)
            {
               _loc1_ = true;
               this.var_1163 = this.var_507;
            }
         }
         this.var_1426 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_253)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1002 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_212 = this.var_212.concat(_loc2_.spriteData);
                     ...
                     {
                        this.var_567 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_324 || _loc1_.actionType == AvatarAction.const_234 || _loc1_.actionType == AvatarAction.const_414)
               {
                  this.var_1002 = true;
               }
            }
