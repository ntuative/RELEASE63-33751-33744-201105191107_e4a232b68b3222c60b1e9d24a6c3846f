   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_282,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_204,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_251,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_154 == "")
         {
            var_69.switchCategory(FigureData.const_204);
         }
      }
