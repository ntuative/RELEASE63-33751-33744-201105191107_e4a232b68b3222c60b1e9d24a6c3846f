package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_786 = new ColorTransform(this.var_1897,this.var_1896,this.var_1898,this._alphaMultiplier);
         this.var_1197 = this.generatePaletteMapForGrayscale(this.var_2460,this.var_2461);
      }
      ...
      {
         return this.var_1197.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1197.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1197.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1197.getValue("alphas") as Array;
      }
