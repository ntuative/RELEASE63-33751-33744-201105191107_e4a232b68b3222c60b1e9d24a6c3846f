package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1339:IWindowContainer;
      
      public static var var_1614:IWindowContainer;
      
      public static var var_2107:int = 6710886;
      ...
      private var var_348:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1134 = [];
         this.var_1390 = [AvatarEditorFigureCategory.const_843,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_260,AvatarEditorFigureCategory.const_888,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1339 == null)
         {
            ...
            var_1339 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1614 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1614 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_419 = new Timer(1000);
         this.var_419.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1390;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_419.stop();
            this.var_419.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_419 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1390);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2270 = this.canChangeOutfit();
            this.var_419.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_348 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_348.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_348.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1134.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_348.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_348.numSelectables)
               {
                  this.var_348.getSelectableAt(_loc6_).x = this.var_348.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_348.setSelected(this.var_348.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1390;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_43) && (this.var_1700 == AvatarEditorSideCategory.const_111 || this.var_2269))
         {
         ...
         this.setViewToCategory(this.var_367);
      }
      ...
      {
         if(this.var_1700 == AvatarEditorSideCategory.const_111)
         {
            this.var_2269 = false;
            this.setSideContent(AvatarEditorSideCategory.const_916);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_916:
               break;
            case AvatarEditorSideCategory.const_590:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_590);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_367 = param1;
         this.var_348.setSelected(this.var_348.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2268 = new Date().valueOf();
                  this.var_2270 = false;
                  this.var_419.start();
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2268 > 5000;
      }
   }
}
