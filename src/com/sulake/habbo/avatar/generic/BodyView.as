package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_637:String = "tab_boy";
      
      private const const_636:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_69.controller.gender)
         {
            case FigureData.const_77:
               ...
               inactivateTab(this.const_636);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_636);
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_637:
                  var_69.controller.gender = FigureData.const_77;
