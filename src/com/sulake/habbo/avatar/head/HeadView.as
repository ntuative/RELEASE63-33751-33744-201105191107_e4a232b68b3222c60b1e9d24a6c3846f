   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_192,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_288,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_249,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_237,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_69,FigureData.const_291,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_154 == "")
         {
            var_69.switchCategory(FigureData.const_192);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_192);
                  break;
               case "tab_hat":
