package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_364 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this.var_618 && this.var_1438)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_92,this.var_933,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_35,parseInt(FigureData.const_810));
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1438 && this.var_618 != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_618 = this._controller.figureData.getFigureString();
            ...
            case "get_button":
               if(this.var_618)
               {
                  this._controller.loadAvatarInEditor(this.var_618,this.var_933,this._controller.clubMemberLevel);
               }
         }
      }
