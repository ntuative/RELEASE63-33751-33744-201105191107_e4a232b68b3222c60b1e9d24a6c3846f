package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_945:int = 3;
      
      private var var_428:AssetLoaderStruct;
      
      private var var_947:Timer;
      ...
      private const const_2218:int = 100;
      
      private const const_1888:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_428 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_947 = new Timer(this.const_2218,1);
         this.var_947.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_428)
         {
            this.var_428.addEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_428.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_428)
         {
            this.var_428.removeEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_428.removeEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_945);
            if(this.var_1453.indexOf("?") > 0)
            {
               _loc2_ = this.var_1453 + "&retry=" + this.var_945;
            }
            else
            {
               _loc2_ = this.var_1453 + "?retry=" + this.var_945;
            ...
            this.var_428 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         for each(_loc2_ in param1.lib)
         {
            ...
            for each(_loc4_ in _loc2_.part)
            {
               ...
               _loc6_ = this.var_1184[_loc5_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(_loc3_);
               this.var_1184[_loc5_] = _loc6_;
            }
         }
      }
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1800)
         {
            this.var_1185.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_545[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_545[_loc3_] = _loc6_;
            }
            this.var_946[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_946)
         {
            _loc7_ = true;
            _loc4_ = this.var_946[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_770.length > 0 && this.var_771.length < this.const_1888)
         {
            _loc1_ = this.var_770[0];
            _loc1_.startDownloading();
            this.var_771.push(this.var_770.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_770.indexOf(param1) == -1 && this.var_771.indexOf(param1) == -1)
         {
            this.var_770.push(param1);
            this.processPending();
         }
      }
