package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1953:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1612:IAvatarImage;
      ...
      private var var_388:IActiveActionData;
      
      private var var_412:AvatarImageBodyPartContainer;
      
      private var var_1529:String;
      
      private var var_125:AvatarImagePartContainer;
      
      private var var_2650:Point;
      ...
      private var var_2651:ByteArray;
      
      private var var_2652:ImageData;
      
      private var var_962:PaletteMap;
      ...
      {
         if(this.var_823 == param1)
         {
            return;
         }
         if(this.var_823 == GeometryType.const_1328 && param1 == GeometryType.const_1101 || this.var_823 == GeometryType.const_1101 && param1 == GeometryType.const_1328)
         {
            this.var_823 = param1;
            this.var_86 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_388 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_388;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_388 || !this.var_388.definition))
         {
            if(this.var_388.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_388.definition.state + "." + this.var_388.actionParameter);
               _loc13_ = param2 - this.var_388.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_388.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_388 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_850)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_533)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1612.getFigure(),_loc5_,this.var_823,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_412 = _loc10_.getImageContainer(_loc4_);
         if(this.var_412 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_412 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_388);
            if(this.var_412 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_412,_loc4_);
         }
         this.var_412.offset = _loc8_;
         return this.var_412;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_86)
         {
            this.var_86 = this._structure.getCanvas(this._scale,this.var_823);
            if(!this.var_86)
            {
               return null;
            }
            this.var_2650 = new Point(0,this.var_86.height - int(this.var_86.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1784[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_904 || _loc10_ == AvatarAction.const_414;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1529 = this.var_125.bodyPartId;
               this.var_186 = this.var_125.partType;
               this.var_1934 = this.var_125.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_125.flippedPartType != this.var_186)
                     {
                        this.var_186 = this.var_125.flippedPartType;
                     }
                  }
               }
               this.var_1530 = this._scale + "_" + this.var_125.action.assetPartDefinition + "_" + this.var_186 + "_" + this.var_1934 + "_" + _loc5_ + "_" + this._frame;
               this.var_447 = this._assets.getAssetByName(this.var_1530) as BitmapDataAsset;
               if(this.var_447 == null)
               {
                  this.var_1530 = this._scale + "_std_" + this.var_186 + "_" + this.var_1934 + "_" + _loc5_ + "_0";
                  this.var_447 = this._assets.getAssetByName(this.var_1530) as BitmapDataAsset;
               }
               if(!(!this.var_447 || !this.var_447.content))
               {
                  ...
                  {
                     this.var_962 = this._structure.renderManager.paletteManager.getPalette(this.var_125.paletteMapId);
                     if(this.var_962 != null)
                     {
                        this.var_1009 = this.var_447.content as BitmapData;
                        this.var_187 = new BitmapData(this.var_1009.width,this.var_1009.height);
                        this.var_2651 = this.var_962.colorize(this.var_1009.getPixels(this.var_1009.rect));
                        this.var_187.setPixels(this.var_187.rect,this.var_2651);
                     }
                     else
                     {
                        this.var_187 = (this.var_447.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1529 == AvatarBodyPartType.const_260 || this.var_1529 == AvatarBodyPartType.const_1824 || this.var_1529 == AvatarBodyPartType.const_1771) && this.var_125.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_125.color.colorTransform);
                  }
                  if(this.var_125.isBlendable)
                  {
                     this.var_187.colorTransform(this.var_187.rect,this.var_125.blendTransform);
                  }
                  this.var_1007 = this.var_447.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_58)
                     {
                  ...
                  this.var_2652 = new ImageData(this.var_187,this.var_1007,_loc7_);
                  this.var_1008.push(this.var_2652);
               }
            }
            _loc8_--;
         }
         if(this.var_1008.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1008,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2650.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_58)
            {
         ...
         _loc8_ = this.var_1008.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1008.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
