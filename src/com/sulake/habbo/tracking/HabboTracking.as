package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1094:uint = 11;
      ...
      private var var_1332:IHabboWindowManager;
      ...
      private var var_282:PerformanceTracker = null;
      
      private var var_473:FramerateTracker = null;
      
      private var var_281:LatencyTracker = null;
      
      private var var_693:LagWarningLogger = null;
      
      private var var_474:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_282 = new PerformanceTracker();
         this.var_473 = new FramerateTracker();
         this.var_281 = new LatencyTracker();
         this.var_693 = new LagWarningLogger();
         this.var_474 = new ToolbarClickTracker(this);
         this.var_1609 = new Array(const_1094);
         var _loc4_:int = 0;
         while(_loc4_ < const_1094)
         {
            this.var_1609[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1698,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1807,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1624,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1332)
            {
               this.var_1332.release(new IIDHabboWindowManager());
               this.var_1332 = null;
            }
            if(this._adManager)
            {
            ...
            if(this.var_216)
            {
               if(!this.var_216.disposed)
               {
                  ...
                  Component(this.var_216).events.removeEventListener(HabboFriendListTrackingEvent.const_564,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_209,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_332,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_351,this.onRoomAction);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_195)
         {
            if(this.var_281 != null)
            {
               this.var_281.configuration = this.var_195;
            }
            if(this.var_282 != null)
            {
               this.var_282.configuration = this.var_195;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1863);
            if(this.var_195)
            {
               if(this.var_693 != null)
               {
                  this.var_693.configure(this.var_195);
               }
               if(this.var_473 != null)
               {
                  this.var_473.configure(this.var_195);
               }
               if(this.var_474 != null)
               {
                  this.var_474.configure(this.var_195);
               }
            }
         }
      }
      ...
      private function method_6(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_909,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_193,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_274,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_848,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_552,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_282 != null)
            {
               this.var_282.connection = param1;
            }
            if(this.var_281 != null)
            {
            ...
            if(this.var_693 != null)
            {
               this.var_693.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_848)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1692);
         }
         else if(param1.type == HabboHotelViewEvent.const_552)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1765);
               break;
            case HabboCommunicationEvent.const_909:
               this.trackLoginStep(HabboLoginTrackingStep.const_1903,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_193:
               this.trackLoginStep(HabboLoginTrackingStep.const_193);
               break;
      ...
      {
         this.var_1332 = IHabboWindowManager(param2);
         if(this.var_1332)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_195)
            {
               if(this.var_195.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1609)
                  {
                  ...
                  if(this.var_282 != null)
                  {
                     _loc4_["null"] = this.var_282.flashVersion;
                     _loc4_["null"] = this.var_282.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1318);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1318,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_216).events.addEventListener(HabboFriendListTrackingEvent.const_564,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_564:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2887)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1887);
            this.var_2887 = true;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_209,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_332,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_351,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this._adManager = param2 as IAdManager;
         this._adManager.events.addEventListener(AdEvent.const_496,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_332)
         {
            if(this.var_2087 < 1)
            {
               if(!this.var_327)
         ...
         else if(param1.type == RoomEngineEvent.const_351)
         {
            if(this.var_327)
            {
               this.var_327.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_473)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_473.frameRate),_loc2_);
                  ++this.var_2087;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_474)
         {
            this.var_474.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_474)
         {
            this.var_474.track(param1.type);
         }
      }
      ...
      {
         this.var_693.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_564 > -1 && _loc2_ < this.var_564)
         {
            ++this.var_2089;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2089);
         }
         if(this.var_564 > -1 && _loc2_ - this.var_564 > 15000)
         {
            ++this.var_2088;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2088);
         }
         this.var_564 = _loc2_;
         if(this.var_282 != null)
         {
            this.var_282.update(param1,this.var_564);
         }
         if(this.var_281 != null)
         {
            this.var_281.update(param1,this.var_564);
         }
         if(this.var_473 != null)
         {
            this.var_473.trackUpdate(param1,this,this.var_564);
         }
         if(this.var_693 != null)
         {
            this.var_693.update(this.var_564);
         }
      }
   }
}
