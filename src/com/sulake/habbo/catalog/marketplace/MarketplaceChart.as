package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_587 = 0;
         for each(_loc4_ in this.var_173)
         {
            if(_loc4_ > this.var_587)
            {
               this.var_587 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_587).toString().length - 1);
         this.var_587 = Math.ceil(this.var_587 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_587.toString();
         _loc3_.draw(_loc6_);
         this.var_1122 = param1 - _loc6_.textWidth - 2;
         this.var_889 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_889);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_889 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1122,(param2 - this.var_889) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1122 + this.var_1122 / -this.var_2934 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_889 - this.var_889 / this.var_587 * this.var_173[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_173 && this._x.length > 1;
      }
   }
}
