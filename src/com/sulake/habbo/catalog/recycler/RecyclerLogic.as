package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1008:int = 0;
      
      private static const const_448:int = 1;
      
      private static const const_1009:int = 2;
      ...
      {
         return this.var_611 != const_1008;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1749 != RecyclerStatusMessageEvent.const_1326;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_611 == const_448;
      }
      ...
      {
         this.var_611 = const_1009;
         this.var_118 = new Array(const_219);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_219)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_611 = const_1008;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1677:
               this.var_611 = const_448;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1326:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1144:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1718:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_118.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_219)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_118.length < const_219)
         {
            return false;
         }
         var _loc1_:int = 0;
