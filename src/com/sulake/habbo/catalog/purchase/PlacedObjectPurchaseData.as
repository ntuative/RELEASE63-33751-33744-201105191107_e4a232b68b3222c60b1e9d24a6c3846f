package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1933:IProductData;
      
      private var var_649:IFurnitureData;
      ...
      {
         this.var_1109 = param1.offerId;
         this.var_1876 = param1.productContainer.firstProduct.productClassId;
         this.var_1933 = param1.productContainer.firstProduct.productData;
         this.var_649 = param1.productContainer.firstProduct.furnitureData;
         this.var_1374 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_217,this._category,this.var_1877,this._x,this.var_173,this._direction,this.var_1109,this.var_1876].toString();
      }
