package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2204:int = 10;
      ...
      private const const_1962:uint = 4.293848814E9;
      
      private const const_1961:uint = 4.294967295E9;
      
      private const const_1546:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1109 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_3);
         }
         ...
         if(_loc6_ != null)
         {
            _loc6_.addEventListener(WindowEvent.const_108,this.onNameInputChange);
            _loc6_.addEventListener(WindowMouseEvent.const_45,this.onNameInputMouseDown);
            _loc6_.addEventListener(WindowKeyboardEvent.const_316,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_313,this.onMessageInputFocus);
         }
         this.var_1664 = true;
         this.var_1663 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_352,this.onFreeWrappingSelected);
               _loc12_.addEventListener(WindowEvent.const_480,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1665 = _loc1_.stuffTypes;
            this.var_718 = _loc1_.boxTypes;
            this.var_719 = _loc1_.ribbonTypes;
            this.var_1110 = this.var_1665[0];
            this.var_344 = this.var_718[0];
            this.var_343 = this.var_719[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_343 < 0)
         {
            this.var_343 = this.var_719.length - 1;
         }
         if(this.var_343 > this.var_719.length - 1)
         {
            this.var_343 = 0;
         }
         if(this.var_344 < 0)
         {
            this.var_344 = this.var_718.length - 1;
         }
         if(this.var_344 > this.var_718.length - 1)
         {
            this.var_344 = 0;
         }
         var _loc1_:int = this.var_718[this.var_344] * 1000 + this.var_719[this.var_343];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1110,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1375 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1665)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc3_,ProductTypeEnum.const_83);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1110);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_718[this.var_344]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_719[this.var_343]);
         this._catalog.purchaseProductAsGift(this.var_1373,this.var_1109,this.var_1374,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1373,this.var_1109,this.var_1374);
         this.dispose();
      }
      ...
      private function method_3(param1:WindowEvent) : void
      {
         this.giveGift();
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2217 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_238)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2204)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2217 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_342 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_342 + 1);
               break;
      ...
      {
         if(this.var_245 == null || !this.var_245.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_245.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_342) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_245 == null)
         {
            this.var_245 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_717 == null)
         {
            this.var_717 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_245 == null || this.var_717 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_245.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_717.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_245.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_342) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_342);
         }
         this.var_342 = param1;
         if(this.var_342 < 0)
         {
            this.var_342 = _loc2_.numListItems - 1;
         }
         if(this.var_342 >= _loc2_.numListItems)
         {
            this.var_342 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_342) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1546;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1962) : uint(this.const_1961);
      }
      ...
      {
         this.var_1110 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1110;
               }
            }
            _loc4_++;
         }
