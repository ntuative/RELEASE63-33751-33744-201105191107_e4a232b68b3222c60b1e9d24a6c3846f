package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1798:Point;
      
      private var var_517:IItemGridWindow;
      
      private var var_1452:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_939 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1183 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1798 = new Point(this.var_88.x,this.var_88.y);
         this.var_517 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1452 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1799 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_939.text = _loc4_;
         this.var_1183.text = _loc5_;
         this.var_939.height = this.var_939.textHeight + 5;
         this.var_1183.y = this.var_939.y + this.var_939.height;
         this.var_1183.height = Math.max(130,this.var_1183.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_531:
                  _loc6_ = this.var_1799.clone();
                  if(this.var_517 != null)
                  {
                     this.var_517.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_517,this.var_1452,this.var_1908);
                     this.var_517.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_418:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_220:
                        ...
                        _loc6_ = new BitmapData(this.var_88.width,this.var_88.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_308,AvatarAction.const_505);
                              _loc16_.appendAction(AvatarAction.const_348,_loc8_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_88);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2431)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2431 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            if(this.var_88.bitmap == null)
            {
               this.var_88.bitmap = new BitmapData(this.var_88.width,this.var_88.height,true,16777215);
            }
            this.var_88.bitmap.fillRect(this.var_88.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_88.width - param1.width) / 2,(this.var_88.height - param1.height) / 2);
            this.var_88.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_88.invalidate();
            this.var_88.x = this.var_1798.x;
            this.var_88.y = this.var_1798.y;
            if(param3 != null)
            {
               this.var_88.x += param3.x;
               this.var_88.y += param3.y;
            }
         }
         if(param2)
         {
