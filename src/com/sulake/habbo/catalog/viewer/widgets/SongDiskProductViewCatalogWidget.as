package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_434:IButtonWindow;
      ...
      {
         super(param1);
         this.var_434 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1243 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_434 != null)
         {
            this.var_434.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_434.disable();
         }
         this.var_1244 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      override public function dispose() : void
      {
         if(this.var_434 != null)
         {
            this.var_434.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_999,HabboMusicPrioritiesEnum.const_202,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_999 = parseInt(_loc2_.extraParam);
            if(this.var_1244 != null)
            {
               this.var_1244.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1243.text = _loc8_;
            }
         }
         else if(this.var_1243 != null)
         {
            this.var_1243.text = "";
         }
         if(this.var_434 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_999);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_999);
         }
         return -1;
      }
