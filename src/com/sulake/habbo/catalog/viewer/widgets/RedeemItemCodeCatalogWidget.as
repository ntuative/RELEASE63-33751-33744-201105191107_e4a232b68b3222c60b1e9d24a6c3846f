package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_966.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_966 = null;
         }
         if(this.var_967 != null)
         {
            this.var_967.removeEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
            this.var_967 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_966 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_966 != null)
         {
            this.var_966.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_967 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_967 != null)
         {
            this.var_967.addEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
         }
         return true;
      }
