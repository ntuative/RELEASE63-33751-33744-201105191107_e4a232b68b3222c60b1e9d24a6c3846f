package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1929:String = "ctlg_";
      ...
      private var var_1255:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1256);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1256);
      }
      ...
      {
         var _loc2_:String = const_1929 + param1;
         ...
         this.var_2151 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2151) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1898:
               if(this.var_1255 == null)
               {
                  this.var_1255 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1255);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1786:
               ...
               break;
            case CatalogWidgetEnum.const_1760:
               this.var_37.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1719:
            ...
            case CatalogWidgetEnum.const_1712:
               ...
               break;
            case CatalogWidgetEnum.const_1664:
               this.var_37.push(new NewPetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1637:
               this.var_37.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1808:
