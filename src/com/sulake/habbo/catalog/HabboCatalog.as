package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_666:uint = 1;
      ...
      private var var_193:CatalogViewer;
      
      private var var_396:ICatalogNavigator;
      
      private var var_111:Purse;
      
      private var var_98:RecyclerLogic;
      
      private var var_149:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var _confirmationDialog:PurchaseConfirmationDialog;
      
      private var var_211:ChargeConfirmationDialog;
      ...
      private var var_2784:Boolean = true;
      
      private var var_2786:Boolean = true;
      
      private var var_2033:Boolean = false;
      
      private var var_2785:GiftWrappingConfiguration;
      
      private var var_1297:ClubGiftController;
      
      private var var_555:ClubBuyController;
      
      private var var_842:Map;
      
      private var var_1296:Boolean = false;
      
      private var var_843:IPurchasableOffer;
      
      private var var_1587:IDragAndDropDoneReceiver;
      
      private var var_61:PlacedObjectPurchaseData;
      
      private const const_1933:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_89,this.onRoomSessionEvent);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_97,this.onRoomSessionEvent);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1648);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_111.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_111.getActivityPointsForType(param1.activityPointType))
         {
         ...
         {
            this.var_555.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_195.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_195.getKey("link.format.credits","/credits");
      ...
      {
         var _loc2_:Array = this.var_842.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_111.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_111.getActivityPointsForType(ActivityPointTypeEnum.PIXEL)));
         var _loc1_:int = 0;
         if(!this.var_111.hasClubLeft)
         {
         ...
         else
         {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_111.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_111.clubPeriods));
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_98 != null && this.getCurrentLayoutCode() == "recycler")
            {
         ...
         this.setupInventoryForRecycler(this.var_98.active && this.mainWindowVisible());
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_193.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_193 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_193.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_666) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1933;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_269,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_2033 = param1.session.isPrivateRoom;
               this.var_1159 = param1.session;
               if(this.var_98 != null)
               {
                  this.var_98.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_97:
               ...
               if(this.var_98 != null)
               {
                  this.var_98.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_98 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_149 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_555 == null)
         {
            this.var_555 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_193 != null)
         {
            this.var_193.catalogWindowClosed();
         }
         if(this.var_98 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_98.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_396.openPage(this.var_844);
            this.var_844 = "";
            this.var_1053 = -1;
         }
         else if(this.var_1053 > -1)
         {
            this.var_396.openPageById(this.var_1053,this.var_2034);
            this.var_1053 = -1;
            this.var_2034 = -1;
            this.var_844 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_193.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_193 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_193.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_111.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2784 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1305);
         }
         this.var_2784 = false;
         if(this.var_211 != null && !this.var_211.disposed)
         {
            this.var_211.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_72,this.var_111.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_111.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2786 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1278);
         }
         this.var_2786 = false;
         if(this.var_211 != null && !this.var_211.disposed)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_111.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_111.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_111.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_111.isVIP = _loc2_.isVIP;
         this.var_111.pastClubDays = _loc2_.pastClubDays;
         this.var_111.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_98 == null)
         {
            return;
         }
         this.var_98.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_98.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_98.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_193.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_149 != null)
         {
            this.var_149.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_149 != null)
         {
            this.var_149.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_149 != null)
         {
            this.var_149.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2785 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_149.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_211 == null || this.var_211.disposed)
         {
            this.var_211 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_211.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_842.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_842.add(_loc2_.productCode,_loc3_.slice());
            this.var_193.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_195.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_195.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_184)
         {
            _loc3_ = this.var_195.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_195.keyExists("catalog.drag_and_drop") || this.var_195.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_222);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_191);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_199);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1296 && param1.type == RoomEngineObjectEvent.const_159)
         {
            this.resetPlacedOfferData(true);
            if(this.var_843 == null || this.var_843.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_843.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_61 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_843);
            _loc5_ = this.var_1587;
            if(_loc5_ != null)
            {
            ...
            else if(_loc2_ == RoomObjectCategoryEnum.const_26)
            {
               switch(_loc3_.furnitureData.name)
               {
                  ...
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.addObjectWallItem(param1.roomId,param1.roomCategory,param1.objectId,_loc3_.productClassId,new Vector3d(param1.x,param1.y,param1.z),new Vector3d(param1.direction * 45,0,0),0,"",false);
               }
            }
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_303,0.5);
            }
         }
      }
      ...
      public function syncPlacedOfferWithPurchase(param1:IPurchasableOffer) : void
      {
         if(this.var_61)
         {
            if(this.var_61.offerId != param1.offerId)
            {
               this.resetPlacedOfferData();
            }
         }
      ...
      public function resetPlacedOfferData(param1:Boolean = false) : void
      {
         ...
         if(this.var_61 != null)
         {
            if(this.var_61.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_61.roomId,this.var_61.roomCategory,this.var_61.objectId);
            }
            else if(this.var_61.category == RoomObjectCategoryEnum.const_26)
            {
               switch(this.var_61.furniData.name)
               {
                  case "floor":
                  case "wallpaper":
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_61.roomId,this.var_61.roomCategory,this.var_61.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_61.objectId,this.var_61.category);
            }
            this.var_61.dispose();
            this.var_61 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(this.var_61 != null && this.var_61.productClassId == param1.classId)
         {
            if(this.var_61.roomCategory == this._roomEngine.activeRoomCategory && this.var_61.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_61.category;
               _loc4_ = this.var_61.wallLocation;
               _loc5_ = this.var_61.x;
               _loc6_ = this.var_61.y;
               _loc7_ = this.var_61.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_320:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_191);
                     if(this.var_61.extraParameter != _loc8_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_358:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_222);
                     if(this.var_61.extraParameter != _loc9_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
                  case FurniCategory.const_346:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_199);
                     if(this.var_61.extraParameter != _loc10_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc2_));
                     }
                     break;
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_195.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_666);
            if(_loc1_ != null)
            {
