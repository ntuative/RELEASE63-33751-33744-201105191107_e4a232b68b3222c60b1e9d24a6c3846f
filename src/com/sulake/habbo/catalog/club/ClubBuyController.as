package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyController
   {
      ...
      private var _confirmationDialog:ClubBuyConfirmationDialog;
      ...
      {
         this.closeConfirmation();
         this._confirmationDialog = new ClubBuyConfirmationDialog(this,param1,param2);
      }
      ...
      public function getClubType() : int
      {
         ...
         {
            _loc1_ = !!this._catalog.getPurse().isVIP ? 0 : int(HabboClubLevelEnum.const_43);
         }
         return _loc1_;
      }
