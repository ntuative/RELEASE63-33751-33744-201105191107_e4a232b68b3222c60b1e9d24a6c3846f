package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.var_984[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2548);
      }
      ...
      {
         var _loc3_:Localization = this.var_63[param1] as Localization;
         if(_loc3_ == null)
         {
            this.var_1228.push(param1);
            return param2;
         }
         return _loc3_.value;
      }
      ...
      {
         var _loc3_:Localization = this.var_63[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_63[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_1858);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_63)
         {
      ...
      {
         var _loc5_:Localization = this.var_63[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_63[param1] = _loc5_;
         }
      ...
      {
         return this.var_63[param1] as ILocalization;
      }
      ...
      public function printNonExistingKeys() : void
      {
         var _loc2_:* = null;
         var _loc1_:String = "";
         for each(_loc2_ in this.var_1228)
         {
            _loc1_ += _loc2_ + "\n";
         }
         Logger.log(_loc1_);
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_63)
         {
            if(_loc2_.raw.indexOf("%predefined%") >= 0)
            {
               _loc2_.registerParameter("predefined",this.var_1858);
            }
         }
      }
   }
