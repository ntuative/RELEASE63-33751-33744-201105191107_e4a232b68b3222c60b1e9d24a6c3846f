package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_208:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_91:Map;
      
      private static var var_563:Array;
      ...
      private static const const_1609:String = "/*";
      
      private static const const_1608:String = "*/";
      ...
      {
         return var_91.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_91.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_91[param1] = param2;
         if(_loc3_)
         {
            var_563.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_91[const_208],var_91[ITALIC],var_91[BOLD]];
            var_91.reset();
            var_91[const_208] = _loc5_[0];
            var_91[ITALIC] = _loc5_[1];
            var_91[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_91[_loc4_.name] = _loc4_;
            if(var_563.indexOf(_loc4_.name) == -1)
            {
               var_563.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_91.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_91.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_674);
         if(countSubStrings(param1,const_673) != countSubStrings(param1,const_674))
         {
            throw new Error("Mismatching amount of \"" + const_673 + "\" versus \"" + const_674 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1609) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1608) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_673)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
