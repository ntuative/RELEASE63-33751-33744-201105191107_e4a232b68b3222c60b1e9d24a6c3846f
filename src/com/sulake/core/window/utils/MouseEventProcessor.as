package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_338 = new Array();
            var_338[0] = MouseCursorType.const_330;
            var_338[1] = MouseCursorType.const_30;
            var_338[2] = MouseCursorType.const_330;
            var_338[3] = MouseCursorType.const_330;
            var_338[4] = MouseCursorType.const_330;
            var_338[5] = MouseCursorType.const_30;
            var_338[6] = MouseCursorType.const_330;
         }
         if(var_289 == null)
         {
            var_289 = new Array();
            var_289[0] = WindowState.const_86;
            var_289[1] = WindowState.const_88;
            var_289[2] = WindowState.const_85;
            var_289[3] = WindowState.const_69;
            var_289[4] = WindowState.const_55;
            var_289[5] = WindowState.const_95;
            var_289[6] = WindowState.const_87;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_211;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_64 = state.var_1336 as WindowController;
         this.var_176 = state.var_1338 as WindowController;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_701.x || event.stageY != this.var_701.y)
            {
               ...
               array = new Array();
               this.var_85.groupParameterFilteredChildrenUnderPoint(this.var_701,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_64 != this.var_85 && !this.var_64.disposed)
                  {
                     this.var_64.getGlobalPosition(var_408);
                     ...
                     this.var_64 = WindowController(this.var_85);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_64 && !this.var_64.disposed)
                     {
                        ...
                        {
                           this.var_874.mouseEventReceived(event.type,this.var_64);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1336 = this.var_64;
         state.var_1338 = this.var_176;
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_512))
         {
