package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2955 = param3 == const_278 || param3 == const_138 || param3 == const_262 || param3 == const_273;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_273:
               ...
               break;
            case const_162:
               _loc1_ = "<var key=\"" + this.var_665 + "\" value=\"" + "0x" + uint(this.var_189).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_665 + "\" value=\"" + this.var_189 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
