package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2014:String = "_INCLUDE";
      
      public static const const_2038:String = "_TEMP";
      
      private static const const_1435:String = "layout";
      
      private static const const_1035:String = "window";
      ...
      private static const const_1442:String = "style";
      
      private static const const_648:String = "params";
      
      private static const const_1441:String = "tags";
      ...
      private static const const_1439:String = "visible";
      
      private static const const_1430:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1146:String = "blend";
      
      private static const const_1437:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1428:String = "treshold";
      
      private static const const_1429:String = "children";
      
      private static const const_1434:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1433:String = "height_min";
      
      private static const const_1436:String = "height_max";
      
      private static const const_649:String = "true";
      
      private static const const_177:String = "0";
      
      private static const const_1438:String = "$";
      ...
      private static const const_1440:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1350:Dictionary;
      
      protected var var_1351:Dictionary;
      
      protected var var_1090:Dictionary;
      
      protected var var_1619:Dictionary;
      
      protected var var_2145:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1351 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1350,this.var_1351);
         this.var_1090 = new Dictionary();
         this.var_1619 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1090,this.var_1619);
         this.var_2145 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1440,const_51);
         return param1.replace(const_1431,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1350)
            {
               delete this.var_1350[_loc1_];
            }
            for(_loc1_ in this.var_1351)
            {
               delete this.var_1351[_loc1_];
            }
            for(_loc1_ in this.var_1090)
            {
               delete this.var_1090[_loc1_];
            }
            for(_loc1_ in this.var_1619)
            {
               delete this.var_1619[_loc1_];
            }
            this.var_2145.dispose();
            this.var_2145 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         if(param1.localName() == const_1435)
         {
            ...
            _loc4_ = param1.child(const_1035);
         ...
         if(param1.localName() == const_1035)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1350[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_455,variables,"")));
         style = uint(this.parseAttribute(xml,const_1442,variables,style));
         params = uint(this.parseAttribute(xml,const_648,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1441,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1439,variables,visible.toString()) == const_649;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_648).length() > 0)
         {
            list = xml.child(const_648).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_455,variables,"") as String;
               if(this.var_1090[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_455)) + "\"!");
               }
               params |= this.var_1090[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1430,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1432);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1434,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1433,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1436,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_649;
         blend = Number(this.parseAttribute(xml,const_1146,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1437,variables,window.clipping.toString()) == const_649;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1428,variables,window.mouseThreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1351[param1.type];
