package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      private var var_813:KeyboardEvent;
      ...
      {
         return this.var_813.charCode;
      }
      
      public function get keyCode() : uint
      {
         return this.var_813.keyCode;
      }
      
      public function get keyLocation() : uint
      {
         return this.var_813.keyLocation;
      }
      
      public function get altKey() : Boolean
      {
         return this.var_813.altKey;
      }
      
      public function get shiftKey() : Boolean
      {
         return this.var_813.shiftKey;
      }
      
      override public function clone() : WindowEvent
      {
         return allocate(_type,this.var_813,window,related,cancelable);
      }
      
      override public function toString() : String
      {
         return "WindowKeyboardEvent { type: " + _type + " cancelable: " + var_475 + " window: " + _window + " charCode: " + this.charCode + " }";
      }
   }
}
