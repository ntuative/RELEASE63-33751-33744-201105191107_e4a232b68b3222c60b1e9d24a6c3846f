package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_366:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_366);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2415 = _loc2_.textWidth;
         this.var_2416 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_366 != _loc2_.color : this.var_366 != null && this.var_366 != PropertyDefaults.const_721) ? new PropertyStruct(PropertyDefaults.const_401,this.var_366,PropertyStruct.const_162,true) : PropertyDefaults.const_1175);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_958)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_40.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_858);
            }
            if(this.var_40.top != PropertyDefaults.const_720)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_240,this.var_40.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_832);
            }
            if(this.var_40.right != PropertyDefaults.const_735)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,this.var_40.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_728);
            }
            if(this.var_40.bottom != PropertyDefaults.const_723)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_40.bottom,PropertyStruct.const_41,true));
            }
            else
            {
