package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1029:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1982:StyleSheet = null;
      ...
      {
         this.var_832 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1274 == param2)
         {
            return;
         }
         param1.var_1274 = param2;
         param1.var_1982 = null;
         if(param1.var_1274 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1274);
            param1.var_1982 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_938.indexOf(param1) > -1)
         {
            this.var_832 = param1;
         }
      }
      ...
      {
         return this.var_832 == LinkTarget.const_30 ? defaultLinkTarget : this.var_832;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1982;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1244)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_832 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_920,this.var_832,PropertyStruct.const_53,true,PropertyDefaults.const_938));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1626);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_920)
            {
               this.var_832 = _loc2_.value as String;
               break;
            }
