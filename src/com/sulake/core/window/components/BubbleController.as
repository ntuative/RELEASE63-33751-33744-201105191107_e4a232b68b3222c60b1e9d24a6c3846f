package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1939:String = "_POINTER_UP";
      
      private static const const_1938:String = "_POINTER_DOWN";
      
      private static const const_1937:String = "_POINTER_LEFT";
      
      private static const const_1936:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_743,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
