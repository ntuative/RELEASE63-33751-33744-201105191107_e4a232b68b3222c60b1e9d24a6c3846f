package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1620:uint = 500;
      
      protected var var_1352:String = "";
      
      protected var var_1344:Boolean = false;
      
      protected var var_768:Boolean = false;
      ...
      {
         this.var_1352 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1191,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_768 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_194,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_407,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_316,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_108,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_680,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1622);
         _loc1_.push(this.var_1344 != PropertyDefaults.const_1300 ? new PropertyStruct(PropertyDefaults.const_760,this.var_1344,PropertyStruct.const_37,true) : PropertyDefaults.const_1654);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1111 ? new PropertyStruct(PropertyDefaults.const_845,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1897);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1107 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1899);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_760:
                  this.var_1344 = _loc2_.value as Boolean;
                  if(this.var_1344)
                  {
               ...
               case PropertyDefaults.const_845:
                  ...
                  break;
               case PropertyDefaults.const_680:
                  _field.type = !!_loc2_.value ? "null" : TextFieldType.DYNAMIC;
                  break;
               case PropertyDefaults.const_1167:
