package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1350:String = "_SELECTOR";
      
      private static const const_1351:String = "_CONTENT";
       
      
      protected var var_1082:ITabSelectorWindow;
      
      protected var var_2139:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1082 = findChildByTag(const_1350) as ITabSelectorWindow;
            if(this.var_1082 != null)
            {
               this.var_1082.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2139 == null)
         {
            this.var_2139 = findChildByTag(const_1351) as IWindowContainer;
         }
      ...
      {
         return !!this.var_768 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1082.numSelectables;
      }
