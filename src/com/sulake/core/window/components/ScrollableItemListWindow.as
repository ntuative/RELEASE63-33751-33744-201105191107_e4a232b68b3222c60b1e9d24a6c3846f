package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1112:IItemListWindow;
      
      private var var_411:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_411)
         {
            this.var_411.removeEventListener(WindowEvent.const_257,this.scrollBarEventProc);
            this.var_411.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_411 = null;
         }
         if(this.var_1112)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1112)
         {
            this.var_1112 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_411)
         {
            this.var_411 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_411)
            {
               this.var_411.addEventListener(WindowEvent.const_257,this.scrollBarEventProc);
               this.var_411.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            }
         }
         return this.var_411;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_289)
         {
            this.hideScrollBar();
         }
      }
