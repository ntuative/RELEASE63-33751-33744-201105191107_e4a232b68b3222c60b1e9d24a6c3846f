package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2164:Boolean = false;
      
      protected var var_573:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_706:Number = -1.0;
      
      protected var var_704:Number = -1.0;
      
      protected var var_1093:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_175 = var_481 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_442,WindowStyle.const_176,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_122,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_196,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1362;
      }
      ...
      {
         return new Rectangle(this.var_703 * this.maxScrollH,this.var_705 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_703 = param1;
            this._container.x = -this.var_703 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_60);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_464,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_618,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_489,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_122,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_196,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_206:
               if(this.var_1359)
               {
                  this.var_1360 = this.var_2163 - _loc3_;
                  this.var_1361 = this.var_2162 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1360 != 0 && this.var_112 != 0)
                     {
                        this.scrollH += this.var_1360 / this.var_112;
                     }
                  }
                  else if(this.var_1361 != 0 && this.var_100 != 0)
                  {
                     this.scrollV += this.var_1361 / this.var_100;
                  }
                  this.var_2163 = _loc3_;
                  this.var_2162 = _loc4_;
                  _loc2_ = true;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1093 && !this.var_573 && this._container)
         {
            this.var_573 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_965)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_397,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1130);
         }
         if(this.var_1093 != PropertyDefaults.const_1319)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_736,this.var_1093,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1731);
         }
         if(this.var_485 != PropertyDefaults.const_1119)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_957,this.var_485,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1711);
         }
         if(this.var_1362 != PropertyDefaults.const_1277)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_968,this.var_1362,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1778);
         }
         if(this.var_706 != PropertyDefaults.const_1170)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_794,this.var_706,PropertyStruct.const_117,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1882);
         }
         if(this.var_704 != PropertyDefaults.const_1301)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_872,this.var_704,PropertyStruct.const_117,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_397:
                  ...
                  break;
               case PropertyDefaults.const_957:
               ...
               case PropertyDefaults.const_736:
                  this.var_1093 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_794:
                  this.var_706 = _loc2_.value as Number;
                  break;
