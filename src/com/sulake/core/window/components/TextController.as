package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1339:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_877:Number;
      
      protected var var_571:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_208);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_676 ? true : null;
         }
      ...
      {
         this.var_877 = param1;
         this._field.scrollH = this.var_877 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_877 * this.maxScrollH,this.var_571 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_684,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1151));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1245 ? new PropertyStruct(PropertyDefaults.const_819,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1266) : PropertyDefaults.const_1663);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_232,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1311 ? new PropertyStruct(PropertyDefaults.const_1135,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1316) : PropertyDefaults.const_1842);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_721) ? new PropertyStruct(PropertyDefaults.const_401,this._field.textColor,PropertyStruct.const_162,true) : PropertyDefaults.const_1175);
         _loc1_.push(this.var_471 != TextStyleManager.const_208 ? new PropertyStruct(PropertyDefaults.const_438,this.var_471,PropertyStruct.const_53,true,PropertyDefaults.const_813) : PropertyDefaults.const_1306);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_958 ? new PropertyStruct(PropertyDefaults.const_242,this.var_40.left,PropertyStruct.const_41,true) : PropertyDefaults.const_858);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_720 ? new PropertyStruct(PropertyDefaults.const_240,this.var_40.top,PropertyStruct.const_41,true) : PropertyDefaults.const_832);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_735 ? new PropertyStruct(PropertyDefaults.const_246,this.var_40.right,PropertyStruct.const_41,true) : PropertyDefaults.const_728);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_723 ? new PropertyStruct(PropertyDefaults.const_294,this.var_40.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_879);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1192 ? new PropertyStruct(PropertyDefaults.const_686,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1838);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_41,this._field.maxChars != 0));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_117,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_117,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_117,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
