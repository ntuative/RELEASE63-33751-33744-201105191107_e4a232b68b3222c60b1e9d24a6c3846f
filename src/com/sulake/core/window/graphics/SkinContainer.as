package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1564:String = "skin";
      
      private static const const_1561:String = "bitmap";
      
      private static const const_1560:String = "fill";
      
      private static const const_1562:String = "text";
      
      private static const const_1563:String = "label";
      
      private static const const_1559:String = "shape";
      ...
      private var var_2055:Dictionary;
      
      private var var_2836:Dictionary;
      
      private var var_2838:Dictionary;
      
      private var var_2837:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2055 = new Dictionary();
         this.var_2836 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2055,this.var_2836);
         this.var_2838 = new Dictionary();
         this.var_2837 = new Dictionary();
         StateCodeTable.fillTables(this.var_2838,this.var_2837);
         this.var_469 = new Dictionary();
         this.var_469[const_1564] = BitmapSkinRenderer;
         this.var_469[const_1561] = BitmapDataRenderer;
         this.var_469[const_1560] = FillSkinRenderer;
         this.var_469[const_1562] = TextSkinRenderer;
         this.var_469[const_1563] = LabelRenderer;
         this.var_469[const_1559] = ShapeSkinRenderer;
         ...
         if(var_339 == null)
         {
            ...
            var_339.push(WindowState.const_95);
            var_339.push(WindowState.const_55);
            var_339.push(WindowState.const_85);
            var_339.push(WindowState.const_88);
            var_339.push(WindowState.const_86);
            var_339.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2909 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2055[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1062[param1] == null)
         {
            this.var_1062[param1] = new Array(const_1088);
         }
         this.var_1062[param1][param2] = param3;
         if(this.var_1063[param1] == null)
         {
            this.var_1063[param1] = new Array(const_1088);
         }
         this.var_1063[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1062[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_176)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1063[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_176)
