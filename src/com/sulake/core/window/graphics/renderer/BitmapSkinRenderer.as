package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_482[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_786.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_786.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_786.blueMultiplier = (param1.color & 255) / 255;
               this.var_786.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_786);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_331 == SkinLayoutEntity.const_328)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_592)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_304)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_331 == SkinLayoutEntity.const_482)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_332 == SkinLayoutEntity.const_328)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_592)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_304)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_482)
                  {
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_304 || _loc10_.var_331 == SkinLayoutEntity.const_304)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_331 == SkinLayoutEntity.const_328)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_332 == SkinLayoutEntity.const_328)
               {
