package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_642:uint = 0;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1019) : uint(const_642);
         var _loc6_:Boolean = this.var_182.width > 0 && this.var_182.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_937))
            {
               _loc5_ = const_1018;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1018)
               {
                  ...
                  if(this.var_620)
                  {
                     ...
                     _loc7_.draw(param1,this.var_120,this.var_120.rect,this.var_937,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     this.var_1091.tx = param2.x;
                     this.var_1091.ty = param2.y;
                     this.var_786.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_120,this.var_1091,this.var_786,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            ...
            {
               _loc2_ = this._skinContainer.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_176);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1448;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1286:
               if(param1.testParamFlag(WindowParam.const_34))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_798:
               this.var_937 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_937 != this.var_1448)
               {
                  this.var_620 = true;
                  _loc4_ = true;
               }
            ...
            case WindowRedrawFlag.const_1146:
               ...
               break;
            case WindowRedrawFlag.const_1142:
               _loc4_ = true;
         }
         if(_loc4_)
         {
