package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_103:String = "HabboNavigatorCom_ros_roomicon_editor_xml";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_331 = SkinLayoutEntity.const_556;
                  break;
               case "move":
                  _loc5_.var_331 = SkinLayoutEntity.const_328;
                  break;
               case "strech":
                  _loc5_.var_331 = SkinLayoutEntity.const_592;
                  break;
               case "tiled":
                  _loc5_.var_331 = SkinLayoutEntity.const_304;
                  break;
               case "center":
                  _loc5_.var_331 = SkinLayoutEntity.const_482;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_332 = SkinLayoutEntity.const_556;
                  break;
               case "move":
                  _loc5_.var_332 = SkinLayoutEntity.const_328;
                  break;
               case "strech":
                  _loc5_.var_332 = SkinLayoutEntity.const_592;
                  break;
               case "tiled":
                  _loc5_.var_332 = SkinLayoutEntity.const_304;
                  break;
               case "center":
                  _loc5_.var_332 = SkinLayoutEntity.const_482;
            }
         }
