package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1688:uint = 0;
      
      public static const const_860:uint = 1;
      
      public static const const_1191:uint = 2;
      
      public static const const_692:uint = 4;
      
      public static const const_1717:uint = 8;
      
      public static const const_1613:uint = 16;
      
      public static const const_2004:uint = 64;
      
      public static const const_2167:uint = 128;
      
      public static const const_1322:uint = 256;
      ...
      protected var var_218:DisplayObjectContainer;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_218.numChildren > 0)
               {
                  this.var_218.removeChildAt(0);
               }
            }
            this.var_218 = null;
            while(numChildren > 0)
         ...
         if(this.var_873)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2153,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2153,16777215);
                  }
                  var_337 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_218 == null)
         {
            this.var_218 = new Sprite();
            this.var_218.name = this.name + " - Child Container";
            this.var_218.mouseEnabled = false;
            addChild(this.var_218);
         }
         return this.var_218;
      }
      ...
      {
         return this.var_218 != null ? int(this.var_218.numChildren) : 0;
      }
