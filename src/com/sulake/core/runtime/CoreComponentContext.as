package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_104:uint = 3;
      
      private static const const_1471:String = "asset-libraries";
      
      private static const const_1472:String = "library";
      
      private static const const_1474:String = "service-libraries";
      
      private static const const_1468:String = "library";
      
      private static const const_1467:String = "component-libraries";
      
      private static const const_1473:String = "library";
      
      private static const const_1470:String = "error_data";
      
      private static const const_1475:String = "error_cat";
      
      private static const const_1469:String = "error_desc";
       
      
      private var var_382:LibraryLoaderQueue;
      
      private var var_799:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_407 = param1;
         var _loc3_:int = 0;
         while(_loc3_ < CoreComponentContext.const_104)
         {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_787:
               ...
               var_407.addChild(new ProfilerViewer(this.var_205));
               break;
            case Core.const_543:
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               i = 0;
               while(i < CoreComponentContext.const_104)
               {
                  receivers = this.var_268[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1470,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1475,String(param3));
         ErrorReportStorage.setParameter(const_1469,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_799 = loadingEventDelegate;
         if(this.var_382 == null)
         {
            this.var_382 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1471)[0];
            if(node != null)
            {
               list = node.child(const_1472);
         ...
         try
         {
            node = config.child(const_1467)[0];
            if(node != null)
            {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1919);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_799)
         {
            this.var_799.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_799)
         {
            ...
            this.var_799.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_799)
                  {
                     this.var_799.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_531 - this.var_382.length,this.var_531,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         param2 = param2 >= CoreComponentContext.const_104 ? 4294967295 : uint(param2);
         var _loc3_:int = !!this.var_205 ? 0 : this.var_1506 & 0;
         if(_loc3_ == Core.const_543)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_205 ? 0 : this.var_1506 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_104)
         {
            _loc3_ = this.var_268[_loc5_] as Array;
            if(_loc4_ == Core.const_543)
            {
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         priority = 0;
         while(priority < CoreComponentContext.const_104)
         {
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            _loc2_ = 0;
            while(_loc2_ < CoreComponentContext.const_104)
            {
