package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1921:uint = 1;
      
      protected static const const_1922:uint = 2;
      
      protected static const const_1924:uint = 4;
      
      protected static const const_1923:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1693:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1102:Boolean = false;
      
      public static const const_1888:int = 2;
      
      private static var var_973:Array = new Array();
      
      private static var var_781:Array = new Array();
      ...
      protected var var_660:Class;
      
      protected var var_476:uint = 0;
      
      protected var _name:String;
      
      protected var var_1088:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1089:Boolean = false;
      ...
      protected var var_2994:uint = 0;
      
      protected var var_2916:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1102)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_781[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_781.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_781.length < const_1888 && false)
            {
               _loc1_ = var_973.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1088 ? uint(this.var_1349 - this.var_2144) : uint(getTimer() - this.var_2144);
      }
      ...
      {
         if(this.var_1089 && !_disposed)
         {
            this.var_1089 = false;
            if(!this.var_1088 && this.var_240)
            {
               this.var_1349 = -1;
      ...
      {
         if(!this.var_1088 && !_disposed && this.var_1348 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1693 - this.var_1348);
            if(this.var_2916)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_476 = LibraryLoader.name_4;
         ...
         if(this.var_476 == LibraryLoader.const_1923)
         {
         ...
         if(this.var_476 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_660 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_660.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
