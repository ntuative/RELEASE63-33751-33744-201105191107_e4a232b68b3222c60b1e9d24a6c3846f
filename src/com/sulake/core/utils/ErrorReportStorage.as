package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1175:Map = new Map();
      
      private static var var_765:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_765.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_765.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_765.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
