package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_643:Map = new Map();
      
      private static const const_363:Map = new Map();
      
      private static var var_1186:Boolean = false;
      ...
      {
         return const_643.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1186)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_643.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1186 = true;
         }
