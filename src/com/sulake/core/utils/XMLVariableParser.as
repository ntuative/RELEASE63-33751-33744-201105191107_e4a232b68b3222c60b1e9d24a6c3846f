package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_232:String = "uint";
      
      public static const const_117:String = "Number";
      
      public static const const_1710:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1879:String = "bool";
      ...
      public static const const_278:String = "Map";
      
      private static const const_669:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_670:String = "value";
      
      private static const const_649:String = "true";
      
      private static const const_1975:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_669);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_669));
         }
         else
         {
            _loc4_ = param1.child(const_669)[0];
         }
         ...
         _loc7_ = param1.attribute(const_670);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_670));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_670)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_278 || _loc5_ == const_138)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1710:
               return Number(param1);
            case const_37:
               return param1 == const_649 || int(param1) > 0;
            case const_1879:
               return param1 == const_649 || int(param1) > 0;
            case const_162:
               return uint(param1);
            case const_138:
               return param1.split(const_1432);
            default:
