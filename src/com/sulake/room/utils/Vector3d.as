package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_173 * this.var_173 + this.var_174 * this.var_174);
         }
         return this._length;
      }
      ...
      {
         this._x = -this._x;
         this.var_173 = -this.var_173;
         this.var_174 = -this.var_174;
      }
      ...
      {
         return "(" + [this._x,this.var_173,this.var_174].join(",") + ")";
      }
   }
}
