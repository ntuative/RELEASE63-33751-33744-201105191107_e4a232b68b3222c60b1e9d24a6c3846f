package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_780:Number = 64;
      
      public static const const_1158:Number = 32;
      ...
      private var var_1834:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1206 = new Vector3d();
         this.var_431 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1205 = new Vector3d();
         this.var_1833 = 1;
         this.var_1834 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1832 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_431.assign(this.var_95);
         this.var_431.x *= this.var_429;
         this.var_431.y *= this.var_430;
         this.var_431.z *= this.var_433;
         return this.var_431;
      }
      ...
      {
         if(this.var_429 != param1 * this.var_1833)
         {
            this.var_429 = param1 * this.var_1833;
            ++this.var_164;
         }
      }
      ...
      {
         if(this.var_430 != param1 * this.var_1834)
         {
            this.var_430 = param1 * this.var_1834;
            ++this.var_164;
         }
      }
      ...
      {
         if(this.var_433 != param1 * this.var_1832)
         {
            this.var_433 = param1 * this.var_1832;
            ++this.var_164;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_95.x;
         var _loc3_:Number = this.var_95.y;
         var _loc4_:Number = this.var_95.z;
         this.var_95.assign(param1);
         this.var_95.x /= this.var_429;
         this.var_95.y /= this.var_430;
         this.var_95.z /= this.var_433;
         if(this.var_95.x != _loc2_ || this.var_95.y != _loc3_ || this.var_95.z != _loc4_)
         {
            ++this.var_164;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_432.x;
         var _loc3_:Number = this.var_432.y;
         var _loc4_:Number = this.var_432.z;
         this.var_432.assign(param1);
         this._direction.assign(param1);
         if(this.var_432.x != _loc2_ || this.var_432.y != _loc3_ || this.var_432.z != _loc4_)
         {
            ++this.var_164;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_173.assign(_loc24_);
            this.var_174.assign(_loc25_);
            this.var_1206.assign(this.var_174);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_173.assign(_loc19_);
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_522 != null)
         {
            ...
            this.var_522.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_522.add(_loc3_,_loc4_);
            ++this.var_164;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_522 != null)
         {
            ...
            return this.var_522.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1205.assign(_loc22_);
         }
         else
         {
            this.var_1205.assign(_loc17_);
         }
         ++this.var_164;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_173);
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_95);
         _loc2_.x *= this.var_429;
         _loc2_.y *= this.var_430;
         _loc2_.z *= this.var_433;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1205);
         if(_loc3_ < this.var_2952 || _loc3_ > this.var_2953)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_173);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         var _loc6_:IVector3d = this.getDisplacenent(param1);
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_95);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_429;
            _loc2_.y *= this.var_430;
            _loc2_.z *= this.var_433;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1205);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_173,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_95.x * this.var_429,this.var_95.y * this.var_430,this.var_95.z * this.var_433);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_174;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_429,param2.y * this.var_430,param2.z * this.var_433);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_429,param3.y * this.var_430,param3.z * this.var_433);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_429,param4.y * this.var_430,param4.z * this.var_433);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1158;
         }
         else
         {
            this.scale = const_780;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_780;
      }
