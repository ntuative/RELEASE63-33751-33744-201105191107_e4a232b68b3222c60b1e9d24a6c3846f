package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_374:IRoomObject;
      
      private var var_848:IGraphicAssetCollection;
      
      protected var var_483:int = -1;
      
      protected var var_153:int = -1;
      
      protected var var_93:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_212 != null)
         {
            ...
            {
               _loc1_ = this.var_212[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_848.removeReference();
         }
         this.var_848 = param1;
         if(this.var_848 != null)
         {
            this.var_848.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_212.length > param1)
         {
            _loc2_ = this.var_212[this.var_212.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
         ...
         while(this.var_212.length < param1)
         {
            ...
            this.var_212.push(_loc2_);
         }
      }
      
      public function get spriteCount() : int
      {
         return this.var_212.length;
      }
      
      public function getSprite(param1:int) : IRoomObjectSprite
      {
         if(param1 >= 0 && param1 < this.var_212.length)
         {
      ...
      {
         this.var_483 = 4294967295;
         this.var_153 = 4294967295;
         this.var_93 = -1;
      }
