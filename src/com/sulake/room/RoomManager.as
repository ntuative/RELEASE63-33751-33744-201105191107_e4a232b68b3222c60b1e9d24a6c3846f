package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1671:int = 0;
      ...
      private var var_159:IRoomManagerListener;
      
      private var var_2975:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_590 = [];
         this.var_589 = [];
         events.addEventListener(RoomContentLoadedEvent.const_428,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_510,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_752,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_591 == null || this.var_492 == null)
         {
            return;
         }
         this._state = const_1676;
         if(this.var_1123 != null)
         {
            _loc1_ = this.var_1123;
            this.var_1123 = null;
            this.initialize(_loc1_,this.var_159);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_590.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_589.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_589[_loc4_];
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_745)
         {
            return;
         }
         if(this.var_54 == null)
         {
            this._state = const_745;
            return;
         }
         if(this.var_54.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_590.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_590.splice(_loc2_,1);
            }
            if(this.var_590.length == 0)
            {
               this._state = const_809;
               if(this.var_159 != null)
               {
                  this.var_159.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_745;
            this.var_159.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_159 != null)
            {
               this.var_159.contentLoaded(null,false);
            }
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_890.length > 0)
         {
            ...
            if(_loc3_ == null)
            {
               if(this.var_159 != null)
               {
                  this.var_159.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_159 != null)
            {
               this.var_159.contentLoaded(_loc2_,true);
            }
            if(this.var_590.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_54 == null || this.var_492 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_591.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_159 != null)
                              {
                                 this.var_159.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
