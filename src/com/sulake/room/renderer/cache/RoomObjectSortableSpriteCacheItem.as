package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      {
         if(param1 != this.var_2605 || param2 != this.var_2604)
         {
      ...
      public function setSpriteCount(param1:int) : void
      {
         ...
         if(param1 < this.var_212.length)
         {
            ...
            this.var_212.splice(param1,this.var_212.length - param1);
         }
         if(this.var_212.length == 0)
         {
            this.var_1907 = true;
         }
         else
