package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_990 = param1 * 1024 * 1024;
         this.var_1881 = param2 * 1024 * 1024;
         this.var_1500 = param3 * 1024 * 1024;
         if(this.var_1500 < 0)
         {
            this.var_1500 = 0;
         }
      ...
      {
         this.var_990 += this.var_1500;
         if(this.var_990 > this.var_1881)
         {
            this.var_990 = this.var_1881;
         }
      }
