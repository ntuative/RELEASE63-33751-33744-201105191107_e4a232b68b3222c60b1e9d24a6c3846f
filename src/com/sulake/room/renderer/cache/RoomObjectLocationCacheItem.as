package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1629 || param1.getUpdateID() != this.var_2392)
         {
            this.var_2392 = param1.getUpdateID();
            if(param2.updateId != this.var_1629 || _loc4_.x != this.var_1177.x || _loc4_.y != this.var_1177.y || _loc4_.z != this.var_1177.z)
            {
